...
open class _PgIndexPosition : AbstractRoutine<Int>("_pg_index_position", InformationSchema.INFORMATION_SCHEMA, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = _PgIndexPosition.RETURN_VALUE
        addInParameter(_PgIndexPosition._1)
        addInParameter(_PgIndexPosition._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Long?): Unit = setValue(_PgIndexPosition._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(_PgIndexPosition._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Short?): Unit = setValue(_PgIndexPosition._2, value)
    ...
    fun set__2(field: Field<Short?>): Unit {
        setField(_PgIndexPosition._2, field)
    }
}
