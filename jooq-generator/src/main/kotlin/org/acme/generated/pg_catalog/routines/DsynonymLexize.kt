...
open class DsynonymLexize : AbstractRoutine<Any>("dsynonym_lexize", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\"")) {
    companion object {
        @Deprecated(message = "Unknown data type. If this is a qualified, user-defined type, it may have been excluded from code generation. If this is a built-in type, you can define an explicit org.jooq.Binding to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.")
    ...
    init {
        returnParameter = DsynonymLexize.RETURN_VALUE
        addInParameter(DsynonymLexize._1)
        addInParameter(DsynonymLexize._2)
        addInParameter(DsynonymLexize._3)
        addInParameter(DsynonymLexize._4)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(DsynonymLexize._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(DsynonymLexize._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(DsynonymLexize._2, value)
    ...
    fun set__2(field: Field<Any?>): Unit {
        setField(DsynonymLexize._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(DsynonymLexize._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(DsynonymLexize._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Any?): Unit = setValue(DsynonymLexize._4, value)
    ...
    fun set__4(field: Field<Any?>): Unit {
        setField(DsynonymLexize._4, field)
    }
}
