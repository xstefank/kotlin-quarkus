...
open class NumericCmp : AbstractRoutine<Int>("numeric_cmp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = NumericCmp.RETURN_VALUE
        addInParameter(NumericCmp._1)
        addInParameter(NumericCmp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: BigDecimal?): Unit = setValue(NumericCmp._1, value)
    ...
    fun set__1(field: Field<BigDecimal?>): Unit {
        setField(NumericCmp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: BigDecimal?): Unit = setValue(NumericCmp._2, value)
