...
open class Encode : AbstractRoutine<String>("encode", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = Encode.RETURN_VALUE
        addInParameter(Encode._1)
        addInParameter(Encode._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: ByteArray?): Unit = setValue(Encode._1, value)
    ...
    fun set__1(field: Field<ByteArray?>): Unit {
        setField(Encode._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(Encode._2, value)
