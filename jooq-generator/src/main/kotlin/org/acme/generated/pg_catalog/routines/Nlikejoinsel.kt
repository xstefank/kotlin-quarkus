...
open class Nlikejoinsel : AbstractRoutine<Double>("nlikejoinsel", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = Nlikejoinsel.RETURN_VALUE
        addInParameter(Nlikejoinsel._1)
        addInParameter(Nlikejoinsel._2)
        addInParameter(Nlikejoinsel._3)
        addInParameter(Nlikejoinsel._4)
        addInParameter(Nlikejoinsel._5)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(Nlikejoinsel._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(Nlikejoinsel._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Nlikejoinsel._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(Nlikejoinsel._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(Nlikejoinsel._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(Nlikejoinsel._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Short?): Unit = setValue(Nlikejoinsel._4, value)
    ...
    fun set__4(field: Field<Short?>): Unit {
        setField(Nlikejoinsel._4, field)
    }

    /**
     * Set the <code>_5</code> parameter IN value to the routine
     */
    fun set__5(value: Any?): Unit = setValue(Nlikejoinsel._5, value)
    ...
    fun set__5(field: Field<Any?>): Unit {
        setField(Nlikejoinsel._5, field)
    }
}
