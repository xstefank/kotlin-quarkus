...
open class ToChar4 : AbstractRoutine<String>("to_char", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = ToChar4.RETURN_VALUE
        addInParameter(ToChar4._1)
        addInParameter(ToChar4._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Int?): Unit = setValue(ToChar4._1, value)
    ...
    fun set__1(field: Field<Int?>): Unit {
        setField(ToChar4._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(ToChar4._2, value)
