...
open class Int42div : AbstractRoutine<Int>("int42div", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = Int42div.RETURN_VALUE
        addInParameter(Int42div._1)
        addInParameter(Int42div._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Int?): Unit = setValue(Int42div._1, value)
    ...
    fun set__1(field: Field<Int?>): Unit {
        setField(Int42div._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Short?): Unit = setValue(Int42div._2, value)
