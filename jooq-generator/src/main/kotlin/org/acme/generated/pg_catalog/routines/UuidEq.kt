...
open class UuidEq : AbstractRoutine<Boolean>("uuid_eq", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = UuidEq.RETURN_VALUE
        addInParameter(UuidEq._1)
        addInParameter(UuidEq._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: UUID?): Unit = setValue(UuidEq._1, value)
    ...
    fun set__1(field: Field<UUID?>): Unit {
        setField(UuidEq._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: UUID?): Unit = setValue(UuidEq._2, value)
