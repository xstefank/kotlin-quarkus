...
open class TimestamptzMiInterval : AbstractRoutine<OffsetDateTime>("timestamptz_mi_interval", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6)) {
    ...
    init {
        returnParameter = TimestamptzMiInterval.RETURN_VALUE
        addInParameter(TimestamptzMiInterval._1)
        addInParameter(TimestamptzMiInterval._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: OffsetDateTime?): Unit = setValue(TimestamptzMiInterval._1, value)
    ...
    fun set__1(field: Field<OffsetDateTime?>): Unit {
        setField(TimestamptzMiInterval._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: YearToSecond?): Unit = setValue(TimestamptzMiInterval._2, value)
    ...
    fun set__2(field: Field<YearToSecond?>): Unit {
        setField(TimestamptzMiInterval._2, field)
    }
}
