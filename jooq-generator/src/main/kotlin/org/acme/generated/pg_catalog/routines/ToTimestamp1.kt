...
open class ToTimestamp1 : AbstractRoutine<OffsetDateTime>("to_timestamp", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6)) {
    ...
    init {
        returnParameter = ToTimestamp1.RETURN_VALUE
        addInParameter(ToTimestamp1._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Double?): Unit = setValue(ToTimestamp1._1, value)
    ...
    fun set__1(field: Field<Double?>): Unit {
        setField(ToTimestamp1._1, field)
    }
}
