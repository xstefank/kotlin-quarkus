...
open class Eqsel : AbstractRoutine<Double>("eqsel", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = Eqsel.RETURN_VALUE
        addInParameter(Eqsel._1)
        addInParameter(Eqsel._2)
        addInParameter(Eqsel._3)
        addInParameter(Eqsel._4)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(Eqsel._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(Eqsel._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Eqsel._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(Eqsel._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(Eqsel._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(Eqsel._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Int?): Unit = setValue(Eqsel._4, value)
