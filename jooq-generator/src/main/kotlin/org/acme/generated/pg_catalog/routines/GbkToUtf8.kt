...
open class GbkToUtf8 : AbstractRoutine<Int>("gbk_to_utf8", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    companion object {
    ...
    init {
        returnParameter = GbkToUtf8.RETURN_VALUE
        addInParameter(GbkToUtf8._1)
        addInParameter(GbkToUtf8._2)
        addInParameter(GbkToUtf8._3)
        addInParameter(GbkToUtf8._4)
        addInParameter(GbkToUtf8._5)
        addInParameter(GbkToUtf8._6)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Int?): Unit = setValue(GbkToUtf8._1, value)
    ...
    fun set__1(field: Field<Int?>): Unit {
        setField(GbkToUtf8._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(GbkToUtf8._2, value)
    ...
    fun set__2(field: Field<Int?>): Unit {
        setField(GbkToUtf8._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(GbkToUtf8._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(GbkToUtf8._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Any?): Unit = setValue(GbkToUtf8._4, value)
    ...
    fun set__4(field: Field<Any?>): Unit {
        setField(GbkToUtf8._4, field)
    }

    /**
     * Set the <code>_5</code> parameter IN value to the routine
     */
    fun set__5(value: Int?): Unit = setValue(GbkToUtf8._5, value)
    ...
    fun set__5(field: Field<Int?>): Unit {
        setField(GbkToUtf8._5, field)
    }

    /**
     * Set the <code>_6</code> parameter IN value to the routine
     */
    fun set__6(value: Boolean?): Unit = setValue(GbkToUtf8._6, value)
