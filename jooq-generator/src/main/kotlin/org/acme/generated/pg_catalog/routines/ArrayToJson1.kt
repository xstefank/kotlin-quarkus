...
open class ArrayToJson1 : AbstractRoutine<JSON>("array_to_json", PgCatalog.PG_CATALOG, SQLDataType.JSON) {
    ...
    init {
        returnParameter = ArrayToJson1.RETURN_VALUE
        addInParameter(ArrayToJson1._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Array<Any?>?): Unit = setValue(ArrayToJson1._1, value)
    ...
    fun set__1(field: Field<Array<Any?>?>): Unit {
        setField(ArrayToJson1._1, field)
    }
}
