...
open class DateTrunc2 : AbstractRoutine<YearToSecond>("date_trunc", PgCatalog.PG_CATALOG, SQLDataType.INTERVAL) {
    ...
    init {
        returnParameter = DateTrunc2.RETURN_VALUE
        addInParameter(DateTrunc2._1)
        addInParameter(DateTrunc2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(DateTrunc2._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(DateTrunc2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: YearToSecond?): Unit = setValue(DateTrunc2._2, value)
