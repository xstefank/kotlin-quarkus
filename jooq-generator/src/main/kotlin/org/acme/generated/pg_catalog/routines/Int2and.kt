...
open class Int2and : AbstractRoutine<Short>("int2and", PgCatalog.PG_CATALOG, SQLDataType.SMALLINT) {
    ...
    init {
        returnParameter = Int2and.RETURN_VALUE
        addInParameter(Int2and._1)
        addInParameter(Int2and._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Short?): Unit = setValue(Int2and._1, value)
    ...
    fun set__1(field: Field<Short?>): Unit {
        setField(Int2and._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Short?): Unit = setValue(Int2and._2, value)
