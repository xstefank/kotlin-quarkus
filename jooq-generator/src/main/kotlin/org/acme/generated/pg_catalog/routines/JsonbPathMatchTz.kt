...
open class JsonbPathMatchTz : AbstractRoutine<Boolean>("jsonb_path_match_tz", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = JsonbPathMatchTz.RETURN_VALUE
        addInParameter(JsonbPathMatchTz.TARGET)
        addInParameter(JsonbPathMatchTz.PATH)
        addInParameter(JsonbPathMatchTz.VARS)
        addInParameter(JsonbPathMatchTz.SILENT)
    }

    /**
     * Set the <code>target</code> parameter IN value to the routine
     */
    fun setTarget(value: JSONB?): Unit = setValue(JsonbPathMatchTz.TARGET, value)
    ...
    fun setTarget(field: Field<JSONB?>): Unit {
        setField(JsonbPathMatchTz.TARGET, field)
    }

    /**
     * Set the <code>path</code> parameter IN value to the routine
     */
    fun setPath(value: Any?): Unit = setValue(JsonbPathMatchTz.PATH, value)
    ...
    fun setPath(field: Field<Any?>): Unit {
        setField(JsonbPathMatchTz.PATH, field)
    }

    /**
     * Set the <code>vars</code> parameter IN value to the routine
     */
    fun setVars(value: JSONB?): Unit = setValue(JsonbPathMatchTz.VARS, value)
    ...
    fun setVars(field: Field<JSONB?>): Unit {
        setField(JsonbPathMatchTz.VARS, field)
    }

    /**
     * Set the <code>silent</code> parameter IN value to the routine
     */
    fun setSilent(value: Boolean?): Unit = setValue(JsonbPathMatchTz.SILENT, value)
    ...
    fun setSilent(field: Field<Boolean?>): Unit {
        setField(JsonbPathMatchTz.SILENT, field)
    }
}
