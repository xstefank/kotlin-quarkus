...
open class Substring8 : AbstractRoutine<String>("substring", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = Substring8.RETURN_VALUE
        addInParameter(Substring8._1)
        addInParameter(Substring8._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Substring8._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Substring8._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Substring8._2, value)
