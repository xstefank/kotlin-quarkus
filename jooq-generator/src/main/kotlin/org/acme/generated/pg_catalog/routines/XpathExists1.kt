...
open class XpathExists1 : AbstractRoutine<Boolean>("xpath_exists", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = XpathExists1.RETURN_VALUE
        addInParameter(XpathExists1._1)
        addInParameter(XpathExists1._2)
        addInParameter(XpathExists1._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(XpathExists1._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(XpathExists1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: XML?): Unit = setValue(XpathExists1._2, value)
    ...
    fun set__2(field: Field<XML?>): Unit {
        setField(XpathExists1._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Array<String?>?): Unit = setValue(XpathExists1._3, value)
    ...
    fun set__3(field: Field<Array<String?>?>): Unit {
        setField(XpathExists1._3, field)
    }
}
