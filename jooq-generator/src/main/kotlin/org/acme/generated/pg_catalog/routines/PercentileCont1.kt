...
open class PercentileCont1 : AbstractRoutine<Double>("percentile_cont", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = PercentileCont1.RETURN_VALUE
        addInParameter(PercentileCont1._1)
        addInParameter(PercentileCont1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Double?): Unit = setValue(PercentileCont1._1, value)
    ...
    fun set__1(field: Field<Double?>): Unit {
        setField(PercentileCont1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Double?): Unit = setValue(PercentileCont1._2, value)
    ...
    fun set__2(field: Field<Double?>): Unit {
        setField(PercentileCont1._2, field)
    }
}
