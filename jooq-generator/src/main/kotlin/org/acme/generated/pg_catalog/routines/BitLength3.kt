...
open class BitLength3 : AbstractRoutine<Int>("bit_length", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = BitLength3.RETURN_VALUE
        addInParameter(BitLength3._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(BitLength3._1, value)
