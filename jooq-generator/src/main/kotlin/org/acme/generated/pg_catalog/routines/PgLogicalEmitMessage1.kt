...
open class PgLogicalEmitMessage1 : AbstractRoutine<Any>("pg_logical_emit_message", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_lsn\"")) {
    companion object {
        @Deprecated(message = "Unknown data type. If this is a qualified, user-defined type, it may have been excluded from code generation. If this is a built-in type, you can define an explicit org.jooq.Binding to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.")
    ...
    init {
        returnParameter = PgLogicalEmitMessage1.RETURN_VALUE
        addInParameter(PgLogicalEmitMessage1._1)
        addInParameter(PgLogicalEmitMessage1._2)
        addInParameter(PgLogicalEmitMessage1._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Boolean?): Unit = setValue(PgLogicalEmitMessage1._1, value)
    ...
    fun set__1(field: Field<Boolean?>): Unit {
        setField(PgLogicalEmitMessage1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(PgLogicalEmitMessage1._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(PgLogicalEmitMessage1._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: String?): Unit = setValue(PgLogicalEmitMessage1._3, value)
    ...
    fun set__3(field: Field<String?>): Unit {
        setField(PgLogicalEmitMessage1._3, field)
    }
}
