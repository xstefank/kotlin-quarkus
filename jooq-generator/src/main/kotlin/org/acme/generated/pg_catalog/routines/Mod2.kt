...
open class Mod2 : AbstractRoutine<Short>("mod", PgCatalog.PG_CATALOG, SQLDataType.SMALLINT) {
    ...
    init {
        returnParameter = Mod2.RETURN_VALUE
        addInParameter(Mod2._1)
        addInParameter(Mod2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Short?): Unit = setValue(Mod2._1, value)
    ...
    fun set__1(field: Field<Short?>): Unit {
        setField(Mod2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Short?): Unit = setValue(Mod2._2, value)
