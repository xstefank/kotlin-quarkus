...
open class RowToJson2 : AbstractRoutine<JSON>("row_to_json", PgCatalog.PG_CATALOG, SQLDataType.JSON) {
    ...
    init {
        returnParameter = RowToJson2.RETURN_VALUE
        addInParameter(RowToJson2._1)
        addInParameter(RowToJson2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Record?): Unit = setValue(RowToJson2._1, value)
    ...
    fun set__1(field: Field<Record?>): Unit {
        setField(RowToJson2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Boolean?): Unit = setValue(RowToJson2._2, value)
