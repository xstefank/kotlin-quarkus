...
open class DistSp : AbstractRoutine<Double>("dist_sp", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = DistSp.RETURN_VALUE
        addInParameter(DistSp._1)
        addInParameter(DistSp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(DistSp._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(DistSp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(DistSp._2, value)
