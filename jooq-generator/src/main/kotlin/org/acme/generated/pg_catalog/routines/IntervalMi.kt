...
open class IntervalMi : AbstractRoutine<YearToSecond>("interval_mi", PgCatalog.PG_CATALOG, SQLDataType.INTERVAL) {
    ...
    init {
        returnParameter = IntervalMi.RETURN_VALUE
        addInParameter(IntervalMi._1)
        addInParameter(IntervalMi._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: YearToSecond?): Unit = setValue(IntervalMi._1, value)
    ...
    fun set__1(field: Field<YearToSecond?>): Unit {
        setField(IntervalMi._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: YearToSecond?): Unit = setValue(IntervalMi._2, value)
