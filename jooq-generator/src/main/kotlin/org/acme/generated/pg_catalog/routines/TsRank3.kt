...
open class TsRank3 : AbstractRoutine<Float>("ts_rank", PgCatalog.PG_CATALOG, SQLDataType.REAL) {
    ...
    init {
        returnParameter = TsRank3.RETURN_VALUE
        addInParameter(TsRank3._1)
        addInParameter(TsRank3._2)
        addInParameter(TsRank3._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Any?): Unit = setValue(TsRank3._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(TsRank3._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(TsRank3._2, value)
    ...
    fun set__2(field: Field<Any?>): Unit {
        setField(TsRank3._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(TsRank3._3, value)
