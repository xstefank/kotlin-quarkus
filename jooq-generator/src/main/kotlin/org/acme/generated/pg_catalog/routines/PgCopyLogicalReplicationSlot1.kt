...
open class PgCopyLogicalReplicationSlot1 : AbstractRoutine<java.lang.Void>("pg_copy_logical_replication_slot", PgCatalog.PG_CATALOG) {
    ...
    init {
        addInParameter(PgCopyLogicalReplicationSlot1.SRC_SLOT_NAME)
        addInParameter(PgCopyLogicalReplicationSlot1.DST_SLOT_NAME)
        addInParameter(PgCopyLogicalReplicationSlot1.TEMPORARY)
        addInParameter(PgCopyLogicalReplicationSlot1.PLUGIN)
        addOutParameter(PgCopyLogicalReplicationSlot1.SLOT_NAME)
        addOutParameter(PgCopyLogicalReplicationSlot1.LSN)
        setOverloaded(true)
    }
     ...
     */
    fun setSrcSlotName(value: String?): Unit = setValue(PgCopyLogicalReplicationSlot1.SRC_SLOT_NAME, value)

    /**
     * Set the <code>dst_slot_name</code> parameter IN value to the routine
     */
    fun setDstSlotName(value: String?): Unit = setValue(PgCopyLogicalReplicationSlot1.DST_SLOT_NAME, value)

    /**
     * Set the <code>temporary</code> parameter IN value to the routine
     */
    fun setTemporary(value: Boolean?): Unit = setValue(PgCopyLogicalReplicationSlot1.TEMPORARY, value)

    /**
     * Set the <code>plugin</code> parameter IN value to the routine
     */
    fun setPlugin(value: String?): Unit = setValue(PgCopyLogicalReplicationSlot1.PLUGIN, value)

    /**
     * Get the <code>slot_name</code> parameter OUT value from the routine
     */
    fun getSlotName(): String? = get(PgCopyLogicalReplicationSlot1.SLOT_NAME)
    @Deprecated(message = "Unknown data type. If this is a qualified, user-defined type, it may have been excluded from code generation. If this is a built-in type, you can define an explicit org.jooq.Binding to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.")
    fun getLsn(): Any? = get(PgCopyLogicalReplicationSlot1.LSN)
}
