...
open class TimetzIn : AbstractRoutine<OffsetTime>("timetz_in", PgCatalog.PG_CATALOG, SQLDataType.TIMEWITHTIMEZONE(6)) {
    ...
    init {
        returnParameter = TimetzIn.RETURN_VALUE
        addInParameter(TimetzIn._1)
        addInParameter(TimetzIn._2)
        addInParameter(TimetzIn._3)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(TimetzIn._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(TimetzIn._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(TimetzIn._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(TimetzIn._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(TimetzIn._3, value)
