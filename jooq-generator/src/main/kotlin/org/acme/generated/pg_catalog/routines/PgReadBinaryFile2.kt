...
open class PgReadBinaryFile2 : AbstractRoutine<ByteArray>("pg_read_binary_file", PgCatalog.PG_CATALOG, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = PgReadBinaryFile2.RETURN_VALUE
        addInParameter(PgReadBinaryFile2._1)
        addInParameter(PgReadBinaryFile2._2)
        addInParameter(PgReadBinaryFile2._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(PgReadBinaryFile2._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(PgReadBinaryFile2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(PgReadBinaryFile2._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(PgReadBinaryFile2._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Long?): Unit = setValue(PgReadBinaryFile2._3, value)
    ...
    fun set__3(field: Field<Long?>): Unit {
        setField(PgReadBinaryFile2._3, field)
    }
}
