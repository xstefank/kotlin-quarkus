...
open class Bit1 : AbstractRoutine<String>("bit", PgCatalog.PG_CATALOG, SQLDataType.CHAR) {
    ...
    init {
        returnParameter = Bit1.RETURN_VALUE
        addInParameter(Bit1._1)
        addInParameter(Bit1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Int?): Unit = setValue(Bit1._1, value)
    ...
    fun set__1(field: Field<Int?>): Unit {
        setField(Bit1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Bit1._2, value)
