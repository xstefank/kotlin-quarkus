...
open class Overlay4 : AbstractRoutine<String>("overlay", PgCatalog.PG_CATALOG, SQLDataType.CHAR) {
    ...
    init {
        returnParameter = Overlay4.RETURN_VALUE
        addInParameter(Overlay4._1)
        addInParameter(Overlay4._2)
        addInParameter(Overlay4._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Overlay4._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Overlay4._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(Overlay4._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(Overlay4._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(Overlay4._3, value)
