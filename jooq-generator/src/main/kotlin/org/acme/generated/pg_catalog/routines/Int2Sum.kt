...
open class Int2Sum : AbstractRoutine<Long>("int2_sum", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    ...
    init {
        returnParameter = Int2Sum.RETURN_VALUE
        addInParameter(Int2Sum._1)
        addInParameter(Int2Sum._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Long?): Unit = setValue(Int2Sum._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(Int2Sum._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Short?): Unit = setValue(Int2Sum._2, value)
