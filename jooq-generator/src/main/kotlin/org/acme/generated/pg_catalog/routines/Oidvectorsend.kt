...
open class Oidvectorsend : AbstractRoutine<ByteArray>("oidvectorsend", PgCatalog.PG_CATALOG, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = Oidvectorsend.RETURN_VALUE
        addInParameter(Oidvectorsend._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Array<Any?>?): Unit = setValue(Oidvectorsend._1, value)
    ...
    fun set__1(field: Field<Array<Any?>?>): Unit {
        setField(Oidvectorsend._1, field)
    }
}
