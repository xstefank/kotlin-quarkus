...
open class SetBit1 : AbstractRoutine<String>("set_bit", PgCatalog.PG_CATALOG, SQLDataType.CHAR) {
    ...
    init {
        returnParameter = SetBit1.RETURN_VALUE
        addInParameter(SetBit1._1)
        addInParameter(SetBit1._2)
        addInParameter(SetBit1._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(SetBit1._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(SetBit1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(SetBit1._2, value)
    ...
    fun set__2(field: Field<Int?>): Unit {
        setField(SetBit1._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(SetBit1._3, value)
