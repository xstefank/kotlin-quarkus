...
open class PgReadFile1 : AbstractRoutine<String>("pg_read_file", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PgReadFile1.RETURN_VALUE
        addInParameter(PgReadFile1._1)
        addInParameter(PgReadFile1._2)
        addInParameter(PgReadFile1._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(PgReadFile1._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(PgReadFile1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(PgReadFile1._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(PgReadFile1._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Long?): Unit = setValue(PgReadFile1._3, value)
