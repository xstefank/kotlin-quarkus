...
open class TimeCmp : AbstractRoutine<Int>("time_cmp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = TimeCmp.RETURN_VALUE
        addInParameter(TimeCmp._1)
        addInParameter(TimeCmp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: LocalTime?): Unit = setValue(TimeCmp._1, value)
    ...
    fun set__1(field: Field<LocalTime?>): Unit {
        setField(TimeCmp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: LocalTime?): Unit = setValue(TimeCmp._2, value)
