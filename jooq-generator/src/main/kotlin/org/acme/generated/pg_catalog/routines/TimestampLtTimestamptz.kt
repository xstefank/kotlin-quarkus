...
open class TimestampLtTimestamptz : AbstractRoutine<Boolean>("timestamp_lt_timestamptz", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = TimestampLtTimestamptz.RETURN_VALUE
        addInParameter(TimestampLtTimestamptz._1)
        addInParameter(TimestampLtTimestamptz._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: LocalDateTime?): Unit = setValue(TimestampLtTimestamptz._1, value)
    ...
    fun set__1(field: Field<LocalDateTime?>): Unit {
        setField(TimestampLtTimestamptz._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetDateTime?): Unit = setValue(TimestampLtTimestamptz._2, value)
    ...
    fun set__2(field: Field<OffsetDateTime?>): Unit {
        setField(TimestampLtTimestamptz._2, field)
    }
}
