...
open class BpcharPatternLt : AbstractRoutine<Boolean>("bpchar_pattern_lt", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = BpcharPatternLt.RETURN_VALUE
        addInParameter(BpcharPatternLt._1)
        addInParameter(BpcharPatternLt._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: String?): Unit = setValue(BpcharPatternLt._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(BpcharPatternLt._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(BpcharPatternLt._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(BpcharPatternLt._2, field)
    }
}
