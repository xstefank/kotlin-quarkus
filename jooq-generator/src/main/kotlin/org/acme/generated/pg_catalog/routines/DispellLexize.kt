...
open class DispellLexize : AbstractRoutine<Any>("dispell_lexize", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\"")) {
    companion object {
        @Deprecated(message = "Unknown data type. If this is a qualified, user-defined type, it may have been excluded from code generation. If this is a built-in type, you can define an explicit org.jooq.Binding to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.")
    ...
    init {
        returnParameter = DispellLexize.RETURN_VALUE
        addInParameter(DispellLexize._1)
        addInParameter(DispellLexize._2)
        addInParameter(DispellLexize._3)
        addInParameter(DispellLexize._4)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(DispellLexize._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(DispellLexize._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(DispellLexize._2, value)
    ...
    fun set__2(field: Field<Any?>): Unit {
        setField(DispellLexize._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(DispellLexize._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(DispellLexize._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Any?): Unit = setValue(DispellLexize._4, value)
    ...
    fun set__4(field: Field<Any?>): Unit {
        setField(DispellLexize._4, field)
    }
}
