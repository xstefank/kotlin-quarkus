...
open class Int8shl : AbstractRoutine<Long>("int8shl", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    ...
    init {
        returnParameter = Int8shl.RETURN_VALUE
        addInParameter(Int8shl._1)
        addInParameter(Int8shl._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Long?): Unit = setValue(Int8shl._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(Int8shl._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Int8shl._2, value)
