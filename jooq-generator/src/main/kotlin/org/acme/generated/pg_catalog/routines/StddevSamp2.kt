...
open class StddevSamp2 : AbstractRoutine<BigDecimal>("stddev_samp", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    ...
    init {
        returnParameter = StddevSamp2.RETURN_VALUE
        addInParameter(StddevSamp2._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Int?): Unit = setValue(StddevSamp2._1, value)
