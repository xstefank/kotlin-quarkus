...
open class Neqsel : AbstractRoutine<Double>("neqsel", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = Neqsel.RETURN_VALUE
        addInParameter(Neqsel._1)
        addInParameter(Neqsel._2)
        addInParameter(Neqsel._3)
        addInParameter(Neqsel._4)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(Neqsel._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(Neqsel._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Neqsel._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(Neqsel._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(Neqsel._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(Neqsel._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Int?): Unit = setValue(Neqsel._4, value)
