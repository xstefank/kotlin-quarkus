...
open class DateLeTimestamp : AbstractRoutine<Boolean>("date_le_timestamp", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = DateLeTimestamp.RETURN_VALUE
        addInParameter(DateLeTimestamp._1)
        addInParameter(DateLeTimestamp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: LocalDate?): Unit = setValue(DateLeTimestamp._1, value)
    ...
    fun set__1(field: Field<LocalDate?>): Unit {
        setField(DateLeTimestamp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: LocalDateTime?): Unit = setValue(DateLeTimestamp._2, value)
    ...
    fun set__2(field: Field<LocalDateTime?>): Unit {
        setField(DateLeTimestamp._2, field)
    }
}
