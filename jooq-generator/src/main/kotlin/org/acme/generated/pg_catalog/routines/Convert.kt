...
open class Convert : AbstractRoutine<ByteArray>("convert", PgCatalog.PG_CATALOG, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = Convert.RETURN_VALUE
        addInParameter(Convert._1)
        addInParameter(Convert._2)
        addInParameter(Convert._3)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: ByteArray?): Unit = setValue(Convert._1, value)
    ...
    fun set__1(field: Field<ByteArray?>): Unit {
        setField(Convert._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(Convert._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(Convert._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: String?): Unit = setValue(Convert._3, value)
