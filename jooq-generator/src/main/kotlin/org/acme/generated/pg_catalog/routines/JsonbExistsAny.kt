...
open class JsonbExistsAny : AbstractRoutine<Boolean>("jsonb_exists_any", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = JsonbExistsAny.RETURN_VALUE
        addInParameter(JsonbExistsAny._1)
        addInParameter(JsonbExistsAny._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: JSONB?): Unit = setValue(JsonbExistsAny._1, value)
    ...
    fun set__1(field: Field<JSONB?>): Unit {
        setField(JsonbExistsAny._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Array<String?>?): Unit = setValue(JsonbExistsAny._2, value)
    ...
    fun set__2(field: Field<Array<String?>?>): Unit {
        setField(JsonbExistsAny._2, field)
    }
}
