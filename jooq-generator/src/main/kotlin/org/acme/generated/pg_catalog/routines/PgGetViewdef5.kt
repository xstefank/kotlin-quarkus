...
open class PgGetViewdef5 : AbstractRoutine<String>("pg_get_viewdef", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PgGetViewdef5.RETURN_VALUE
        addInParameter(PgGetViewdef5._1)
        addInParameter(PgGetViewdef5._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Long?): Unit = setValue(PgGetViewdef5._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(PgGetViewdef5._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(PgGetViewdef5._2, value)
    ...
    fun set__2(field: Field<Int?>): Unit {
        setField(PgGetViewdef5._2, field)
    }
}
