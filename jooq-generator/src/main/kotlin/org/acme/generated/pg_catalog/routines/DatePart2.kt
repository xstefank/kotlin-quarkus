...
open class DatePart2 : AbstractRoutine<Double>("date_part", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = DatePart2.RETURN_VALUE
        addInParameter(DatePart2._1)
        addInParameter(DatePart2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(DatePart2._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(DatePart2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: YearToSecond?): Unit = setValue(DatePart2._2, value)
