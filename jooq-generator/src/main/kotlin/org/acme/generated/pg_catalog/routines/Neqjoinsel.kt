...
open class Neqjoinsel : AbstractRoutine<Double>("neqjoinsel", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = Neqjoinsel.RETURN_VALUE
        addInParameter(Neqjoinsel._1)
        addInParameter(Neqjoinsel._2)
        addInParameter(Neqjoinsel._3)
        addInParameter(Neqjoinsel._4)
        addInParameter(Neqjoinsel._5)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(Neqjoinsel._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(Neqjoinsel._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Neqjoinsel._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(Neqjoinsel._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(Neqjoinsel._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(Neqjoinsel._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Short?): Unit = setValue(Neqjoinsel._4, value)
    ...
    fun set__4(field: Field<Short?>): Unit {
        setField(Neqjoinsel._4, field)
    }

    /**
     * Set the <code>_5</code> parameter IN value to the routine
     */
    fun set__5(value: Any?): Unit = setValue(Neqjoinsel._5, value)
