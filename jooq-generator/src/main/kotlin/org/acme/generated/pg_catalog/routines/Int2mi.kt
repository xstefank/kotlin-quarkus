...
open class Int2mi : AbstractRoutine<Short>("int2mi", PgCatalog.PG_CATALOG, SQLDataType.SMALLINT) {
    ...
    init {
        returnParameter = Int2mi.RETURN_VALUE
        addInParameter(Int2mi._1)
        addInParameter(Int2mi._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Short?): Unit = setValue(Int2mi._1, value)
    ...
    fun set__1(field: Field<Short?>): Unit {
        setField(Int2mi._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Short?): Unit = setValue(Int2mi._2, value)
