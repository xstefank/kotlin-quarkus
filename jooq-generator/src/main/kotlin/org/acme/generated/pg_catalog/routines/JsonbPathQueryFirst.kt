...
open class JsonbPathQueryFirst : AbstractRoutine<JSONB>("jsonb_path_query_first", PgCatalog.PG_CATALOG, SQLDataType.JSONB) {
    ...
    init {
        returnParameter = JsonbPathQueryFirst.RETURN_VALUE
        addInParameter(JsonbPathQueryFirst.TARGET)
        addInParameter(JsonbPathQueryFirst.PATH)
        addInParameter(JsonbPathQueryFirst.VARS)
        addInParameter(JsonbPathQueryFirst.SILENT)
    }

    /**
     * Set the <code>target</code> parameter IN value to the routine
     */
    fun setTarget(value: JSONB?): Unit = setValue(JsonbPathQueryFirst.TARGET, value)
    ...
    fun setTarget(field: Field<JSONB?>): Unit {
        setField(JsonbPathQueryFirst.TARGET, field)
    }

    /**
     * Set the <code>path</code> parameter IN value to the routine
     */
    fun setPath(value: Any?): Unit = setValue(JsonbPathQueryFirst.PATH, value)
    ...
    fun setPath(field: Field<Any?>): Unit {
        setField(JsonbPathQueryFirst.PATH, field)
    }

    /**
     * Set the <code>vars</code> parameter IN value to the routine
     */
    fun setVars(value: JSONB?): Unit = setValue(JsonbPathQueryFirst.VARS, value)
    ...
    fun setVars(field: Field<JSONB?>): Unit {
        setField(JsonbPathQueryFirst.VARS, field)
    }

    /**
     * Set the <code>silent</code> parameter IN value to the routine
     */
    fun setSilent(value: Boolean?): Unit = setValue(JsonbPathQueryFirst.SILENT, value)
    ...
    fun setSilent(field: Field<Boolean?>): Unit {
        setField(JsonbPathQueryFirst.SILENT, field)
    }
}
