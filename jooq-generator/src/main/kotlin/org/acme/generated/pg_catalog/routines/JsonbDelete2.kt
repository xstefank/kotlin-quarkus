...
open class JsonbDelete2 : AbstractRoutine<JSONB>("jsonb_delete", PgCatalog.PG_CATALOG, SQLDataType.JSONB) {
    ...
    init {
        returnParameter = JsonbDelete2.RETURN_VALUE
        addInParameter(JsonbDelete2._1)
        addInParameter(JsonbDelete2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: JSONB?): Unit = setValue(JsonbDelete2._1, value)
    ...
    fun set__1(field: Field<JSONB?>): Unit {
        setField(JsonbDelete2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(JsonbDelete2._2, value)
    ...
    fun set__2(field: Field<Int?>): Unit {
        setField(JsonbDelete2._2, field)
    }
}
