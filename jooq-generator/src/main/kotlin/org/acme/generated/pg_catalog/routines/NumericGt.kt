...
open class NumericGt : AbstractRoutine<Boolean>("numeric_gt", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = NumericGt.RETURN_VALUE
        addInParameter(NumericGt._1)
        addInParameter(NumericGt._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: BigDecimal?): Unit = setValue(NumericGt._1, value)
    ...
    fun set__1(field: Field<BigDecimal?>): Unit {
        setField(NumericGt._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: BigDecimal?): Unit = setValue(NumericGt._2, value)
