...
open class Byteaeq : AbstractRoutine<Boolean>("byteaeq", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Byteaeq.RETURN_VALUE
        addInParameter(Byteaeq._1)
        addInParameter(Byteaeq._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: ByteArray?): Unit = setValue(Byteaeq._1, value)
    ...
    fun set__1(field: Field<ByteArray?>): Unit {
        setField(Byteaeq._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: ByteArray?): Unit = setValue(Byteaeq._2, value)
