...
open class ToChar6 : AbstractRoutine<String>("to_char", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = ToChar6.RETURN_VALUE
        addInParameter(ToChar6._1)
        addInParameter(ToChar6._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Float?): Unit = setValue(ToChar6._1, value)
    ...
    fun set__1(field: Field<Float?>): Unit {
        setField(ToChar6._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(ToChar6._2, value)
