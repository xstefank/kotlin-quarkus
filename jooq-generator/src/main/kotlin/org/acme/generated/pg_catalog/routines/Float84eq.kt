...
open class Float84eq : AbstractRoutine<Boolean>("float84eq", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Float84eq.RETURN_VALUE
        addInParameter(Float84eq._1)
        addInParameter(Float84eq._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Double?): Unit = setValue(Float84eq._1, value)
    ...
    fun set__1(field: Field<Double?>): Unit {
        setField(Float84eq._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Float?): Unit = setValue(Float84eq._2, value)
