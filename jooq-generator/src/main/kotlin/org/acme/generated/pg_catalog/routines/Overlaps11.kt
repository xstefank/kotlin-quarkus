...
open class Overlaps11 : AbstractRoutine<Boolean>("overlaps", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Overlaps11.RETURN_VALUE
        addInParameter(Overlaps11._1)
        addInParameter(Overlaps11._2)
        addInParameter(Overlaps11._3)
        addInParameter(Overlaps11._4)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: LocalDateTime?): Unit = setValue(Overlaps11._1, value)
    ...
    fun set__1(field: Field<LocalDateTime?>): Unit {
        setField(Overlaps11._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: YearToSecond?): Unit = setValue(Overlaps11._2, value)
    ...
    fun set__2(field: Field<YearToSecond?>): Unit {
        setField(Overlaps11._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: LocalDateTime?): Unit = setValue(Overlaps11._3, value)
    ...
    fun set__3(field: Field<LocalDateTime?>): Unit {
        setField(Overlaps11._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: YearToSecond?): Unit = setValue(Overlaps11._4, value)
