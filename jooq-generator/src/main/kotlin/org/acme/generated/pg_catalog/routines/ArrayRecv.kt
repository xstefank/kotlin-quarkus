...
open class ArrayRecv : AbstractRoutine<Array<Any?>>("array_recv", PgCatalog.PG_CATALOG, SQLDataType.OTHER.array()) {
    companion object {
    ...
    init {
        returnParameter = ArrayRecv.RETURN_VALUE
        addInParameter(ArrayRecv._1)
        addInParameter(ArrayRecv._2)
        addInParameter(ArrayRecv._3)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(ArrayRecv._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(ArrayRecv._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(ArrayRecv._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(ArrayRecv._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(ArrayRecv._3, value)
