...
open class Btfloat4cmp : AbstractRoutine<Int>("btfloat4cmp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = Btfloat4cmp.RETURN_VALUE
        addInParameter(Btfloat4cmp._1)
        addInParameter(Btfloat4cmp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Float?): Unit = setValue(Btfloat4cmp._1, value)
    ...
    fun set__1(field: Field<Float?>): Unit {
        setField(Btfloat4cmp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Float?): Unit = setValue(Btfloat4cmp._2, value)
