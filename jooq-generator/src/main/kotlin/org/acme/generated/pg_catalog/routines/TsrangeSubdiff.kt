...
open class TsrangeSubdiff : AbstractRoutine<Double>("tsrange_subdiff", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = TsrangeSubdiff.RETURN_VALUE
        addInParameter(TsrangeSubdiff._1)
        addInParameter(TsrangeSubdiff._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: LocalDateTime?): Unit = setValue(TsrangeSubdiff._1, value)
    ...
    fun set__1(field: Field<LocalDateTime?>): Unit {
        setField(TsrangeSubdiff._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: LocalDateTime?): Unit = setValue(TsrangeSubdiff._2, value)
    ...
    fun set__2(field: Field<LocalDateTime?>): Unit {
        setField(TsrangeSubdiff._2, field)
    }
}
