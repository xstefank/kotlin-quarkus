...
open class Format1 : AbstractRoutine<String>("format", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = Format1.RETURN_VALUE
        addInParameter(Format1._1)
        addInParameter(Format1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Format1._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Format1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(Format1._2, value)
