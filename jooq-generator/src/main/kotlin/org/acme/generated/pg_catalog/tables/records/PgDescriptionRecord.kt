...
open class PgDescriptionRecord() : UpdatableRecordImpl<PgDescriptionRecord>(PgDescription.PG_DESCRIPTION) {
     ...
     */
    constructor(objoid: Long? = null, classoid: Long? = null, objsubid: Int? = null, description: String? = null): this() {
        this.objoid = objoid
