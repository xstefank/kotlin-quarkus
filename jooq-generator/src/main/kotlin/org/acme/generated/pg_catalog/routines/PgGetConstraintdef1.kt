...
open class PgGetConstraintdef1 : AbstractRoutine<String>("pg_get_constraintdef", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PgGetConstraintdef1.RETURN_VALUE
        addInParameter(PgGetConstraintdef1._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Long?): Unit = setValue(PgGetConstraintdef1._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(PgGetConstraintdef1._1, field)
    }
}
