...
open class JustifyInterval : AbstractRoutine<YearToSecond>("justify_interval", PgCatalog.PG_CATALOG, SQLDataType.INTERVAL) {
    ...
    init {
        returnParameter = JustifyInterval.RETURN_VALUE
        addInParameter(JustifyInterval._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: YearToSecond?): Unit = setValue(JustifyInterval._1, value)
    ...
    fun set__1(field: Field<YearToSecond?>): Unit {
        setField(JustifyInterval._1, field)
    }
}
