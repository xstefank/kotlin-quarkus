...
open class Int4xor : AbstractRoutine<Int>("int4xor", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = Int4xor.RETURN_VALUE
        addInParameter(Int4xor._1)
        addInParameter(Int4xor._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Int?): Unit = setValue(Int4xor._1, value)
    ...
    fun set__1(field: Field<Int?>): Unit {
        setField(Int4xor._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Int4xor._2, value)
