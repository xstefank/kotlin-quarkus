...
open class ObjDescription2 : AbstractRoutine<String>("obj_description", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = ObjDescription2.RETURN_VALUE
        addInParameter(ObjDescription2._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Long?): Unit = setValue(ObjDescription2._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(ObjDescription2._1, field)
    }
}
