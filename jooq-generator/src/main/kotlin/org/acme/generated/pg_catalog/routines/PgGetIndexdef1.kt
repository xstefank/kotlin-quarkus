...
open class PgGetIndexdef1 : AbstractRoutine<String>("pg_get_indexdef", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PgGetIndexdef1.RETURN_VALUE
        addInParameter(PgGetIndexdef1._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Long?): Unit = setValue(PgGetIndexdef1._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(PgGetIndexdef1._1, field)
    }
}
