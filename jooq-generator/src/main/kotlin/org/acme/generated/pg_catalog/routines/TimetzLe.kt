...
open class TimetzLe : AbstractRoutine<Boolean>("timetz_le", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = TimetzLe.RETURN_VALUE
        addInParameter(TimetzLe._1)
        addInParameter(TimetzLe._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: OffsetTime?): Unit = setValue(TimetzLe._1, value)
    ...
    fun set__1(field: Field<OffsetTime?>): Unit {
        setField(TimetzLe._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetTime?): Unit = setValue(TimetzLe._2, value)
