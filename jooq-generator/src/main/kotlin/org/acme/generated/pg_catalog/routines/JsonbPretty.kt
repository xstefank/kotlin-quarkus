...
open class JsonbPretty : AbstractRoutine<String>("jsonb_pretty", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = JsonbPretty.RETURN_VALUE
        addInParameter(JsonbPretty._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: JSONB?): Unit = setValue(JsonbPretty._1, value)
