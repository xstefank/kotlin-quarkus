...
open class ToChar1 : AbstractRoutine<String>("to_char", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = ToChar1.RETURN_VALUE
        addInParameter(ToChar1._1)
        addInParameter(ToChar1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: YearToSecond?): Unit = setValue(ToChar1._1, value)
    ...
    fun set__1(field: Field<YearToSecond?>): Unit {
        setField(ToChar1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(ToChar1._2, value)
