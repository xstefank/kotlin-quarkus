...
open class PgCopyLogicalReplicationSlot2 : AbstractRoutine<java.lang.Void>("pg_copy_logical_replication_slot", PgCatalog.PG_CATALOG) {
    ...
    init {
        addInParameter(PgCopyLogicalReplicationSlot2.SRC_SLOT_NAME)
        addInParameter(PgCopyLogicalReplicationSlot2.DST_SLOT_NAME)
        addInParameter(PgCopyLogicalReplicationSlot2.TEMPORARY)
        addOutParameter(PgCopyLogicalReplicationSlot2.SLOT_NAME)
        addOutParameter(PgCopyLogicalReplicationSlot2.LSN)
        setOverloaded(true)
    }
     ...
     */
    fun setSrcSlotName(value: String?): Unit = setValue(PgCopyLogicalReplicationSlot2.SRC_SLOT_NAME, value)

    /**
     * Set the <code>dst_slot_name</code> parameter IN value to the routine
     */
    fun setDstSlotName(value: String?): Unit = setValue(PgCopyLogicalReplicationSlot2.DST_SLOT_NAME, value)

    /**
     * Set the <code>temporary</code> parameter IN value to the routine
     */
    fun setTemporary(value: Boolean?): Unit = setValue(PgCopyLogicalReplicationSlot2.TEMPORARY, value)

    /**
     * Get the <code>slot_name</code> parameter OUT value from the routine
     */
    fun getSlotName(): String? = get(PgCopyLogicalReplicationSlot2.SLOT_NAME)
    @Deprecated(message = "Unknown data type. If this is a qualified, user-defined type, it may have been excluded from code generation. If this is a built-in type, you can define an explicit org.jooq.Binding to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.")
    fun getLsn(): Any? = get(PgCopyLogicalReplicationSlot2.LSN)
}
