...
open class Cideq : AbstractRoutine<Boolean>("cideq", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Cideq.RETURN_VALUE
        addInParameter(Cideq._1)
        addInParameter(Cideq._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Long?): Unit = setValue(Cideq._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(Cideq._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Cideq._2, value)
