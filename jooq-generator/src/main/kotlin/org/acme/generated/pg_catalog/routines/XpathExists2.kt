...
open class XpathExists2 : AbstractRoutine<Boolean>("xpath_exists", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = XpathExists2.RETURN_VALUE
        addInParameter(XpathExists2._1)
        addInParameter(XpathExists2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(XpathExists2._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(XpathExists2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: XML?): Unit = setValue(XpathExists2._2, value)
    ...
    fun set__2(field: Field<XML?>): Unit {
        setField(XpathExists2._2, field)
    }
}
