...
open class TimestamptzGe : AbstractRoutine<Boolean>("timestamptz_ge", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = TimestamptzGe.RETURN_VALUE
        addInParameter(TimestamptzGe._1)
        addInParameter(TimestamptzGe._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: OffsetDateTime?): Unit = setValue(TimestamptzGe._1, value)
    ...
    fun set__1(field: Field<OffsetDateTime?>): Unit {
        setField(TimestamptzGe._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetDateTime?): Unit = setValue(TimestamptzGe._2, value)
    ...
    fun set__2(field: Field<OffsetDateTime?>): Unit {
        setField(TimestamptzGe._2, field)
    }
}
