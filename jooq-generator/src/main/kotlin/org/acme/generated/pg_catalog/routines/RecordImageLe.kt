...
open class RecordImageLe : AbstractRoutine<Boolean>("record_image_le", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = RecordImageLe.RETURN_VALUE
        addInParameter(RecordImageLe._1)
        addInParameter(RecordImageLe._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Record?): Unit = setValue(RecordImageLe._1, value)
    ...
    fun set__1(field: Field<Record?>): Unit {
        setField(RecordImageLe._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Record?): Unit = setValue(RecordImageLe._2, value)
    ...
    fun set__2(field: Field<Record?>): Unit {
        setField(RecordImageLe._2, field)
    }
}
