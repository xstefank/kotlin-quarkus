...
open class StddevSamp3 : AbstractRoutine<BigDecimal>("stddev_samp", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    ...
    init {
        returnParameter = StddevSamp3.RETURN_VALUE
        addInParameter(StddevSamp3._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Short?): Unit = setValue(StddevSamp3._1, value)
