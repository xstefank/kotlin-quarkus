...
open class Overlaps3 : AbstractRoutine<Boolean>("overlaps", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Overlaps3.RETURN_VALUE
        addInParameter(Overlaps3._1)
        addInParameter(Overlaps3._2)
        addInParameter(Overlaps3._3)
        addInParameter(Overlaps3._4)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: OffsetDateTime?): Unit = setValue(Overlaps3._1, value)
    ...
    fun set__1(field: Field<OffsetDateTime?>): Unit {
        setField(Overlaps3._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: YearToSecond?): Unit = setValue(Overlaps3._2, value)
    ...
    fun set__2(field: Field<YearToSecond?>): Unit {
        setField(Overlaps3._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: OffsetDateTime?): Unit = setValue(Overlaps3._3, value)
    ...
    fun set__3(field: Field<OffsetDateTime?>): Unit {
        setField(Overlaps3._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: YearToSecond?): Unit = setValue(Overlaps3._4, value)
