...
open class DomainRecv : AbstractRoutine<Any>("domain_recv", PgCatalog.PG_CATALOG, SQLDataType.OTHER) {
    ...
    init {
        returnParameter = DomainRecv.RETURN_VALUE
        addInParameter(DomainRecv._1)
        addInParameter(DomainRecv._2)
        addInParameter(DomainRecv._3)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(DomainRecv._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(DomainRecv._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(DomainRecv._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(DomainRecv._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(DomainRecv._3, value)
