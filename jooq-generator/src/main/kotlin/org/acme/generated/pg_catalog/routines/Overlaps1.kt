...
open class Overlaps1 : AbstractRoutine<Boolean>("overlaps", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Overlaps1.RETURN_VALUE
        addInParameter(Overlaps1._1)
        addInParameter(Overlaps1._2)
        addInParameter(Overlaps1._3)
        addInParameter(Overlaps1._4)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: OffsetTime?): Unit = setValue(Overlaps1._1, value)
    ...
    fun set__1(field: Field<OffsetTime?>): Unit {
        setField(Overlaps1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetTime?): Unit = setValue(Overlaps1._2, value)
    ...
    fun set__2(field: Field<OffsetTime?>): Unit {
        setField(Overlaps1._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: OffsetTime?): Unit = setValue(Overlaps1._3, value)
    ...
    fun set__3(field: Field<OffsetTime?>): Unit {
        setField(Overlaps1._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: OffsetTime?): Unit = setValue(Overlaps1._4, value)
