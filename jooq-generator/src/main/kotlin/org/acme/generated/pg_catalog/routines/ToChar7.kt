...
open class ToChar7 : AbstractRoutine<String>("to_char", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = ToChar7.RETURN_VALUE
        addInParameter(ToChar7._1)
        addInParameter(ToChar7._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Double?): Unit = setValue(ToChar7._1, value)
    ...
    fun set__1(field: Field<Double?>): Unit {
        setField(ToChar7._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(ToChar7._2, value)
