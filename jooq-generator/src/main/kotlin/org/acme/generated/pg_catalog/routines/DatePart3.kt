...
open class DatePart3 : AbstractRoutine<Double>("date_part", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = DatePart3.RETURN_VALUE
        addInParameter(DatePart3._1)
        addInParameter(DatePart3._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(DatePart3._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(DatePart3._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetTime?): Unit = setValue(DatePart3._2, value)
