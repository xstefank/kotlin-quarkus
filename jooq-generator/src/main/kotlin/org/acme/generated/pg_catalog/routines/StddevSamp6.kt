...
open class StddevSamp6 : AbstractRoutine<BigDecimal>("stddev_samp", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    ...
    init {
        returnParameter = StddevSamp6.RETURN_VALUE
        addInParameter(StddevSamp6._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: BigDecimal?): Unit = setValue(StddevSamp6._1, value)
