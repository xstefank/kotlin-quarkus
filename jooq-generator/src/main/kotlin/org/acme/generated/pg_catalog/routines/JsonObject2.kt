...
open class JsonObject2 : AbstractRoutine<JSON>("json_object", PgCatalog.PG_CATALOG, SQLDataType.JSON) {
    ...
    init {
        returnParameter = JsonObject2.RETURN_VALUE
        addInParameter(JsonObject2._1)
        addInParameter(JsonObject2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Array<String?>?): Unit = setValue(JsonObject2._1, value)
    ...
    fun set__1(field: Field<Array<String?>?>): Unit {
        setField(JsonObject2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Array<String?>?): Unit = setValue(JsonObject2._2, value)
