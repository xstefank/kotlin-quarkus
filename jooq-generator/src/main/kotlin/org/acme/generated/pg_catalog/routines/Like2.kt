...
open class Like2 : AbstractRoutine<Boolean>("like", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Like2.RETURN_VALUE
        addInParameter(Like2._1)
        addInParameter(Like2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Like2._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Like2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(Like2._2, value)
