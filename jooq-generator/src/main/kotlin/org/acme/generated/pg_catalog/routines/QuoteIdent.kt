...
open class QuoteIdent : AbstractRoutine<String>("quote_ident", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = QuoteIdent.RETURN_VALUE
        addInParameter(QuoteIdent._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: String?): Unit = setValue(QuoteIdent._1, value)
