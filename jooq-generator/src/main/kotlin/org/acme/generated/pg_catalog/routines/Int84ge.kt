...
open class Int84ge : AbstractRoutine<Boolean>("int84ge", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Int84ge.RETURN_VALUE
        addInParameter(Int84ge._1)
        addInParameter(Int84ge._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Long?): Unit = setValue(Int84ge._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(Int84ge._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Int84ge._2, value)
