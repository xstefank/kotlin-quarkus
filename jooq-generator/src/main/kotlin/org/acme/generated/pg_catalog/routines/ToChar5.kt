...
open class ToChar5 : AbstractRoutine<String>("to_char", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = ToChar5.RETURN_VALUE
        addInParameter(ToChar5._1)
        addInParameter(ToChar5._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Long?): Unit = setValue(ToChar5._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(ToChar5._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(ToChar5._2, value)
