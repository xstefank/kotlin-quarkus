...
open class ArrayDims : AbstractRoutine<String>("array_dims", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = ArrayDims.RETURN_VALUE
        addInParameter(ArrayDims._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Array<Any?>?): Unit = setValue(ArrayDims._1, value)
