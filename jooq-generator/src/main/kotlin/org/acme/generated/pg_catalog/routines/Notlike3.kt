...
open class Notlike3 : AbstractRoutine<Boolean>("notlike", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Notlike3.RETURN_VALUE
        addInParameter(Notlike3._1)
        addInParameter(Notlike3._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: ByteArray?): Unit = setValue(Notlike3._1, value)
    ...
    fun set__1(field: Field<ByteArray?>): Unit {
        setField(Notlike3._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: ByteArray?): Unit = setValue(Notlike3._2, value)
