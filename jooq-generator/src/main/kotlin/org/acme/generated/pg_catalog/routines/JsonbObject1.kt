...
open class JsonbObject1 : AbstractRoutine<JSONB>("jsonb_object", PgCatalog.PG_CATALOG, SQLDataType.JSONB) {
    ...
    init {
        returnParameter = JsonbObject1.RETURN_VALUE
        addInParameter(JsonbObject1._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Array<String?>?): Unit = setValue(JsonbObject1._1, value)
    ...
    fun set__1(field: Field<Array<String?>?>): Unit {
        setField(JsonbObject1._1, field)
    }
}
