...
open class Variance6 : AbstractRoutine<BigDecimal>("variance", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    ...
    init {
        returnParameter = Variance6.RETURN_VALUE
        addInParameter(Variance6._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: BigDecimal?): Unit = setValue(Variance6._1, value)
