...
open class PgReadFile3 : AbstractRoutine<String>("pg_read_file", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PgReadFile3.RETURN_VALUE
        addInParameter(PgReadFile3._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(PgReadFile3._1, value)
