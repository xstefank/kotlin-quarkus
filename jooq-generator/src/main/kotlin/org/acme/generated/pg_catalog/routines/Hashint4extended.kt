...
open class Hashint4extended : AbstractRoutine<Long>("hashint4extended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    ...
    init {
        returnParameter = Hashint4extended.RETURN_VALUE
        addInParameter(Hashint4extended._1)
        addInParameter(Hashint4extended._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Int?): Unit = setValue(Hashint4extended._1, value)
    ...
    fun set__1(field: Field<Int?>): Unit {
        setField(Hashint4extended._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Hashint4extended._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(Hashint4extended._2, field)
    }
}
