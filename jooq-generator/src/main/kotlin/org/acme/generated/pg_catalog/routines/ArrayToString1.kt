...
open class ArrayToString1 : AbstractRoutine<String>("array_to_string", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = ArrayToString1.RETURN_VALUE
        addInParameter(ArrayToString1._1)
        addInParameter(ArrayToString1._2)
        addInParameter(ArrayToString1._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Array<Any?>?): Unit = setValue(ArrayToString1._1, value)
    ...
    fun set__1(field: Field<Array<Any?>?>): Unit {
        setField(ArrayToString1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(ArrayToString1._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(ArrayToString1._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: String?): Unit = setValue(ArrayToString1._3, value)
    ...
    fun set__3(field: Field<String?>): Unit {
        setField(ArrayToString1._3, field)
    }
}
