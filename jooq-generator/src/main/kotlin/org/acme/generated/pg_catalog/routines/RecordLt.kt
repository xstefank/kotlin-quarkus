...
open class RecordLt : AbstractRoutine<Boolean>("record_lt", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = RecordLt.RETURN_VALUE
        addInParameter(RecordLt._1)
        addInParameter(RecordLt._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Record?): Unit = setValue(RecordLt._1, value)
    ...
    fun set__1(field: Field<Record?>): Unit {
        setField(RecordLt._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Record?): Unit = setValue(RecordLt._2, value)
