...
open class Extract5 : AbstractRoutine<BigDecimal>("extract", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    companion object {
    ...
    init {
        returnParameter = Extract5.RETURN_VALUE
        addInParameter(Extract5._1)
        addInParameter(Extract5._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Extract5._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Extract5._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetDateTime?): Unit = setValue(Extract5._2, value)
