...
open class TsRank1 : AbstractRoutine<Float>("ts_rank", PgCatalog.PG_CATALOG, SQLDataType.REAL) {
    ...
    init {
        returnParameter = TsRank1.RETURN_VALUE
        addInParameter(TsRank1._1)
        addInParameter(TsRank1._2)
        addInParameter(TsRank1._3)
        addInParameter(TsRank1._4)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Array<Float?>?): Unit = setValue(TsRank1._1, value)
    ...
    fun set__1(field: Field<Array<Float?>?>): Unit {
        setField(TsRank1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(TsRank1._2, value)
    ...
    fun set__2(field: Field<Any?>): Unit {
        setField(TsRank1._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(TsRank1._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(TsRank1._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Int?): Unit = setValue(TsRank1._4, value)
