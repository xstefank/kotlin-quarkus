...
open class Int4rangeSubdiff : AbstractRoutine<Double>("int4range_subdiff", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = Int4rangeSubdiff.RETURN_VALUE
        addInParameter(Int4rangeSubdiff._1)
        addInParameter(Int4rangeSubdiff._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Int?): Unit = setValue(Int4rangeSubdiff._1, value)
    ...
    fun set__1(field: Field<Int?>): Unit {
        setField(Int4rangeSubdiff._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Int4rangeSubdiff._2, value)
    ...
    fun set__2(field: Field<Int?>): Unit {
        setField(Int4rangeSubdiff._2, field)
    }
}
