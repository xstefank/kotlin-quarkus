...
open class TsRank4 : AbstractRoutine<Float>("ts_rank", PgCatalog.PG_CATALOG, SQLDataType.REAL) {
    ...
    init {
        returnParameter = TsRank4.RETURN_VALUE
        addInParameter(TsRank4._1)
        addInParameter(TsRank4._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Any?): Unit = setValue(TsRank4._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(TsRank4._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(TsRank4._2, value)
