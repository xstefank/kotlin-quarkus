...
open class TsHeadline1 : AbstractRoutine<String>("ts_headline", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = TsHeadline1.RETURN_VALUE
        addInParameter(TsHeadline1._1)
        addInParameter(TsHeadline1._2)
        addInParameter(TsHeadline1._3)
        addInParameter(TsHeadline1._4)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Any?): Unit = setValue(TsHeadline1._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(TsHeadline1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(TsHeadline1._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(TsHeadline1._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(TsHeadline1._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(TsHeadline1._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: String?): Unit = setValue(TsHeadline1._4, value)
