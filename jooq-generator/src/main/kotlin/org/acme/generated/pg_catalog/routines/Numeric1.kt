...
open class Numeric1 : AbstractRoutine<BigDecimal>("numeric", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    ...
    init {
        returnParameter = Numeric1.RETURN_VALUE
        addInParameter(Numeric1._1)
        addInParameter(Numeric1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: BigDecimal?): Unit = setValue(Numeric1._1, value)
    ...
    fun set__1(field: Field<BigDecimal?>): Unit {
        setField(Numeric1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Numeric1._2, value)
