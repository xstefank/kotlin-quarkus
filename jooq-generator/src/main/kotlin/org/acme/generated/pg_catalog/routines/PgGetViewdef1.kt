...
open class PgGetViewdef1 : AbstractRoutine<String>("pg_get_viewdef", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PgGetViewdef1.RETURN_VALUE
        addInParameter(PgGetViewdef1._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(PgGetViewdef1._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(PgGetViewdef1._1, field)
    }
}
