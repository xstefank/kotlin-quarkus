...
open class NumrangeSubdiff : AbstractRoutine<Double>("numrange_subdiff", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = NumrangeSubdiff.RETURN_VALUE
        addInParameter(NumrangeSubdiff._1)
        addInParameter(NumrangeSubdiff._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: BigDecimal?): Unit = setValue(NumrangeSubdiff._1, value)
    ...
    fun set__1(field: Field<BigDecimal?>): Unit {
        setField(NumrangeSubdiff._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: BigDecimal?): Unit = setValue(NumrangeSubdiff._2, value)
    ...
    fun set__2(field: Field<BigDecimal?>): Unit {
        setField(NumrangeSubdiff._2, field)
    }
}
