...
open class Oidvectorle : AbstractRoutine<Boolean>("oidvectorle", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Oidvectorle.RETURN_VALUE
        addInParameter(Oidvectorle._1)
        addInParameter(Oidvectorle._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Array<Any?>?): Unit = setValue(Oidvectorle._1, value)
    ...
    fun set__1(field: Field<Array<Any?>?>): Unit {
        setField(Oidvectorle._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Array<Any?>?): Unit = setValue(Oidvectorle._2, value)
