...
open class DatetimetzPl : AbstractRoutine<OffsetDateTime>("datetimetz_pl", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6)) {
    ...
    init {
        returnParameter = DatetimetzPl.RETURN_VALUE
        addInParameter(DatetimetzPl._1)
        addInParameter(DatetimetzPl._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: LocalDate?): Unit = setValue(DatetimetzPl._1, value)
    ...
    fun set__1(field: Field<LocalDate?>): Unit {
        setField(DatetimetzPl._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetTime?): Unit = setValue(DatetimetzPl._2, value)
    ...
    fun set__2(field: Field<OffsetTime?>): Unit {
        setField(DatetimetzPl._2, field)
    }
}
