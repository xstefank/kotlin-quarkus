...
open class Btrim2 : AbstractRoutine<String>("btrim", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = Btrim2.RETURN_VALUE
        addInParameter(Btrim2._1)
        addInParameter(Btrim2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Btrim2._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Btrim2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(Btrim2._2, value)
