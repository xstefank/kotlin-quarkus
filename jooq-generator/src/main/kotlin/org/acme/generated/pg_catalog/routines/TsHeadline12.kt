...
open class TsHeadline12 : AbstractRoutine<JSON>("ts_headline", PgCatalog.PG_CATALOG, SQLDataType.JSON) {
    ...
    init {
        returnParameter = TsHeadline12.RETURN_VALUE
        addInParameter(TsHeadline12._1)
        addInParameter(TsHeadline12._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: JSON?): Unit = setValue(TsHeadline12._1, value)
    ...
    fun set__1(field: Field<JSON?>): Unit {
        setField(TsHeadline12._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(TsHeadline12._2, value)
    ...
    fun set__2(field: Field<Any?>): Unit {
        setField(TsHeadline12._2, field)
    }
}
