...
open class Overlaps7 : AbstractRoutine<Boolean>("overlaps", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Overlaps7.RETURN_VALUE
        addInParameter(Overlaps7._1)
        addInParameter(Overlaps7._2)
        addInParameter(Overlaps7._3)
        addInParameter(Overlaps7._4)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: LocalTime?): Unit = setValue(Overlaps7._1, value)
    ...
    fun set__1(field: Field<LocalTime?>): Unit {
        setField(Overlaps7._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: YearToSecond?): Unit = setValue(Overlaps7._2, value)
    ...
    fun set__2(field: Field<YearToSecond?>): Unit {
        setField(Overlaps7._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: LocalTime?): Unit = setValue(Overlaps7._3, value)
    ...
    fun set__3(field: Field<LocalTime?>): Unit {
        setField(Overlaps7._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: YearToSecond?): Unit = setValue(Overlaps7._4, value)
