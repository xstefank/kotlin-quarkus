...
open class Int82pl : AbstractRoutine<Long>("int82pl", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    ...
    init {
        returnParameter = Int82pl.RETURN_VALUE
        addInParameter(Int82pl._1)
        addInParameter(Int82pl._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Long?): Unit = setValue(Int82pl._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(Int82pl._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Short?): Unit = setValue(Int82pl._2, value)
