...
open class DateMi : AbstractRoutine<Int>("date_mi", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = DateMi.RETURN_VALUE
        addInParameter(DateMi._1)
        addInParameter(DateMi._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: LocalDate?): Unit = setValue(DateMi._1, value)
    ...
    fun set__1(field: Field<LocalDate?>): Unit {
        setField(DateMi._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: LocalDate?): Unit = setValue(DateMi._2, value)
