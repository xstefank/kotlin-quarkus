...
open class Oidvectorge : AbstractRoutine<Boolean>("oidvectorge", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Oidvectorge.RETURN_VALUE
        addInParameter(Oidvectorge._1)
        addInParameter(Oidvectorge._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Array<Any?>?): Unit = setValue(Oidvectorge._1, value)
    ...
    fun set__1(field: Field<Array<Any?>?>): Unit {
        setField(Oidvectorge._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Array<Any?>?): Unit = setValue(Oidvectorge._2, value)
