...
open class TimestampLtDate : AbstractRoutine<Boolean>("timestamp_lt_date", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = TimestampLtDate.RETURN_VALUE
        addInParameter(TimestampLtDate._1)
        addInParameter(TimestampLtDate._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: LocalDateTime?): Unit = setValue(TimestampLtDate._1, value)
    ...
    fun set__1(field: Field<LocalDateTime?>): Unit {
        setField(TimestampLtDate._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: LocalDate?): Unit = setValue(TimestampLtDate._2, value)
    ...
    fun set__2(field: Field<LocalDate?>): Unit {
        setField(TimestampLtDate._2, field)
    }
}
