...
open class Float48mi : AbstractRoutine<Double>("float48mi", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = Float48mi.RETURN_VALUE
        addInParameter(Float48mi._1)
        addInParameter(Float48mi._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Float?): Unit = setValue(Float48mi._1, value)
    ...
    fun set__1(field: Field<Float?>): Unit {
        setField(Float48mi._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Double?): Unit = setValue(Float48mi._2, value)
