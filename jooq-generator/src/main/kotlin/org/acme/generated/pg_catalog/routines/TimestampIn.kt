...
open class TimestampIn : AbstractRoutine<LocalDateTime>("timestamp_in", PgCatalog.PG_CATALOG, SQLDataType.LOCALDATETIME(6)) {
    ...
    init {
        returnParameter = TimestampIn.RETURN_VALUE
        addInParameter(TimestampIn._1)
        addInParameter(TimestampIn._2)
        addInParameter(TimestampIn._3)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(TimestampIn._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(TimestampIn._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(TimestampIn._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(TimestampIn._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(TimestampIn._3, value)
