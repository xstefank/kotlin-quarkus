...
open class Float84mi : AbstractRoutine<Double>("float84mi", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = Float84mi.RETURN_VALUE
        addInParameter(Float84mi._1)
        addInParameter(Float84mi._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Double?): Unit = setValue(Float84mi._1, value)
    ...
    fun set__1(field: Field<Double?>): Unit {
        setField(Float84mi._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Float?): Unit = setValue(Float84mi._2, value)
