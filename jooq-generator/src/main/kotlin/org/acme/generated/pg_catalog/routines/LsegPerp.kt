...
open class LsegPerp : AbstractRoutine<Boolean>("lseg_perp", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = LsegPerp.RETURN_VALUE
        addInParameter(LsegPerp._1)
        addInParameter(LsegPerp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(LsegPerp._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(LsegPerp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(LsegPerp._2, value)
