...
open class NumericSend : AbstractRoutine<ByteArray>("numeric_send", PgCatalog.PG_CATALOG, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = NumericSend.RETURN_VALUE
        addInParameter(NumericSend._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: BigDecimal?): Unit = setValue(NumericSend._1, value)
