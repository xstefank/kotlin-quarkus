...
open class Isfinite2 : AbstractRoutine<Boolean>("isfinite", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Isfinite2.RETURN_VALUE
        addInParameter(Isfinite2._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: OffsetDateTime?): Unit = setValue(Isfinite2._1, value)
