...
open class Timestamptypmodin : AbstractRoutine<Int>("timestamptypmodin", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = Timestamptypmodin.RETURN_VALUE
        addInParameter(Timestamptypmodin._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Array<Any?>?): Unit = setValue(Timestamptypmodin._1, value)
    ...
    fun set__1(field: Field<Array<Any?>?>): Unit {
        setField(Timestamptypmodin._1, field)
    }
}
