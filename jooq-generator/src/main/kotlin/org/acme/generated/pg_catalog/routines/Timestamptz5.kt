...
open class Timestamptz5 : AbstractRoutine<OffsetDateTime>("timestamptz", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6)) {
    ...
    init {
        returnParameter = Timestamptz5.RETURN_VALUE
        addInParameter(Timestamptz5._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: LocalDateTime?): Unit = setValue(Timestamptz5._1, value)
    ...
    fun set__1(field: Field<LocalDateTime?>): Unit {
        setField(Timestamptz5._1, field)
    }
}
