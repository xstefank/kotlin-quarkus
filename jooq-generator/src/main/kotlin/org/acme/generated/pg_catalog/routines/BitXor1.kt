...
open class BitXor1 : AbstractRoutine<Short>("bit_xor", PgCatalog.PG_CATALOG, SQLDataType.SMALLINT) {
    companion object {
    ...
    init {
        returnParameter = BitXor1.RETURN_VALUE
        addInParameter(BitXor1._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Short?): Unit = setValue(BitXor1._1, value)
