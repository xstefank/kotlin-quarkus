...
open class Timezone3 : AbstractRoutine<OffsetTime>("timezone", PgCatalog.PG_CATALOG, SQLDataType.TIMEWITHTIMEZONE(6)) {
    ...
    init {
        returnParameter = Timezone3.RETURN_VALUE
        addInParameter(Timezone3._1)
        addInParameter(Timezone3._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Timezone3._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Timezone3._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetTime?): Unit = setValue(Timezone3._2, value)
