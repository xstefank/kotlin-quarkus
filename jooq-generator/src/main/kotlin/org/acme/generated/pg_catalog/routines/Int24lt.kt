...
open class Int24lt : AbstractRoutine<Boolean>("int24lt", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Int24lt.RETURN_VALUE
        addInParameter(Int24lt._1)
        addInParameter(Int24lt._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Short?): Unit = setValue(Int24lt._1, value)
    ...
    fun set__1(field: Field<Short?>): Unit {
        setField(Int24lt._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Int24lt._2, value)
