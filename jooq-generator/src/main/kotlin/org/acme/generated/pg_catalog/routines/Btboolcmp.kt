...
open class Btboolcmp : AbstractRoutine<Int>("btboolcmp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = Btboolcmp.RETURN_VALUE
        addInParameter(Btboolcmp._1)
        addInParameter(Btboolcmp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Boolean?): Unit = setValue(Btboolcmp._1, value)
    ...
    fun set__1(field: Field<Boolean?>): Unit {
        setField(Btboolcmp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Boolean?): Unit = setValue(Btboolcmp._2, value)
