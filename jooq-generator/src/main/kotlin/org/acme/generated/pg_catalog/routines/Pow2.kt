...
open class Pow2 : AbstractRoutine<BigDecimal>("pow", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    ...
    init {
        returnParameter = Pow2.RETURN_VALUE
        addInParameter(Pow2._1)
        addInParameter(Pow2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: BigDecimal?): Unit = setValue(Pow2._1, value)
    ...
    fun set__1(field: Field<BigDecimal?>): Unit {
        setField(Pow2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: BigDecimal?): Unit = setValue(Pow2._2, value)
