...
open class Int4gt : AbstractRoutine<Boolean>("int4gt", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Int4gt.RETURN_VALUE
        addInParameter(Int4gt._1)
        addInParameter(Int4gt._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Int?): Unit = setValue(Int4gt._1, value)
    ...
    fun set__1(field: Field<Int?>): Unit {
        setField(Int4gt._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Int4gt._2, value)
