...
open class TsHeadline5 : AbstractRoutine<JSONB>("ts_headline", PgCatalog.PG_CATALOG, SQLDataType.JSONB) {
    ...
    init {
        returnParameter = TsHeadline5.RETURN_VALUE
        addInParameter(TsHeadline5._1)
        addInParameter(TsHeadline5._2)
        addInParameter(TsHeadline5._3)
        addInParameter(TsHeadline5._4)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Any?): Unit = setValue(TsHeadline5._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(TsHeadline5._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: JSONB?): Unit = setValue(TsHeadline5._2, value)
    ...
    fun set__2(field: Field<JSONB?>): Unit {
        setField(TsHeadline5._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(TsHeadline5._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(TsHeadline5._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: String?): Unit = setValue(TsHeadline5._4, value)
