...
open class BitCount2 : AbstractRoutine<Long>("bit_count", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    companion object {
    ...
    init {
        returnParameter = BitCount2.RETURN_VALUE
        addInParameter(BitCount2._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: ByteArray?): Unit = setValue(BitCount2._1, value)
