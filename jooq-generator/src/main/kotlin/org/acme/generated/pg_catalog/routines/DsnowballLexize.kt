...
open class DsnowballLexize : AbstractRoutine<Any>("dsnowball_lexize", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\"")) {
    companion object {
        @Deprecated(message = "Unknown data type. If this is a qualified, user-defined type, it may have been excluded from code generation. If this is a built-in type, you can define an explicit org.jooq.Binding to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.")
    ...
    init {
        returnParameter = DsnowballLexize.RETURN_VALUE
        addInParameter(DsnowballLexize._1)
        addInParameter(DsnowballLexize._2)
        addInParameter(DsnowballLexize._3)
        addInParameter(DsnowballLexize._4)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(DsnowballLexize._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(DsnowballLexize._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(DsnowballLexize._2, value)
    ...
    fun set__2(field: Field<Any?>): Unit {
        setField(DsnowballLexize._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(DsnowballLexize._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(DsnowballLexize._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Any?): Unit = setValue(DsnowballLexize._4, value)
    ...
    fun set__4(field: Field<Any?>): Unit {
        setField(DsnowballLexize._4, field)
    }
}
