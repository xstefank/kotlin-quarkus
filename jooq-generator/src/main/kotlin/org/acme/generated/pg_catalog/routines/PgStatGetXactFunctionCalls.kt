...
open class PgStatGetXactFunctionCalls : AbstractRoutine<Long>("pg_stat_get_xact_function_calls", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    ...
    init {
        returnParameter = PgStatGetXactFunctionCalls.RETURN_VALUE
        addInParameter(PgStatGetXactFunctionCalls._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Long?): Unit = setValue(PgStatGetXactFunctionCalls._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(PgStatGetXactFunctionCalls._1, field)
    }
}
