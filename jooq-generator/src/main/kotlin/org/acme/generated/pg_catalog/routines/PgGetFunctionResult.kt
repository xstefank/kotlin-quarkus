...
open class PgGetFunctionResult : AbstractRoutine<String>("pg_get_function_result", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PgGetFunctionResult.RETURN_VALUE
        addInParameter(PgGetFunctionResult._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Long?): Unit = setValue(PgGetFunctionResult._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(PgGetFunctionResult._1, field)
    }
}
