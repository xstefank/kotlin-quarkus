...
open class PgSizePretty1 : AbstractRoutine<String>("pg_size_pretty", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PgSizePretty1.RETURN_VALUE
        addInParameter(PgSizePretty1._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Long?): Unit = setValue(PgSizePretty1._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(PgSizePretty1._1, field)
    }
}
