...
open class Int8decAny : AbstractRoutine<Long>("int8dec_any", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    ...
    init {
        returnParameter = Int8decAny.RETURN_VALUE
        addInParameter(Int8decAny._1)
        addInParameter(Int8decAny._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Long?): Unit = setValue(Int8decAny._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(Int8decAny._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(Int8decAny._2, value)
