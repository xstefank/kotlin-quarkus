...
open class Bpcharsend : AbstractRoutine<ByteArray>("bpcharsend", PgCatalog.PG_CATALOG, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = Bpcharsend.RETURN_VALUE
        addInParameter(Bpcharsend._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: String?): Unit = setValue(Bpcharsend._1, value)
