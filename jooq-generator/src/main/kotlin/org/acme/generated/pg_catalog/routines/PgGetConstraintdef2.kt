...
open class PgGetConstraintdef2 : AbstractRoutine<String>("pg_get_constraintdef", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PgGetConstraintdef2.RETURN_VALUE
        addInParameter(PgGetConstraintdef2._1)
        addInParameter(PgGetConstraintdef2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Long?): Unit = setValue(PgGetConstraintdef2._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(PgGetConstraintdef2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Boolean?): Unit = setValue(PgGetConstraintdef2._2, value)
    ...
    fun set__2(field: Field<Boolean?>): Unit {
        setField(PgGetConstraintdef2._2, field)
    }
}
