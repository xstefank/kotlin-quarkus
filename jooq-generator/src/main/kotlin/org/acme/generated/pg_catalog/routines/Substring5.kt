...
open class Substring5 : AbstractRoutine<String>("substring", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = Substring5.RETURN_VALUE
        addInParameter(Substring5._1)
        addInParameter(Substring5._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Substring5._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Substring5._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(Substring5._2, value)
