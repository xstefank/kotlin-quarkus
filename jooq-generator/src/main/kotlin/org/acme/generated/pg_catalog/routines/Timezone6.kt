...
open class Timezone6 : AbstractRoutine<OffsetDateTime>("timezone", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6)) {
    ...
    init {
        returnParameter = Timezone6.RETURN_VALUE
        addInParameter(Timezone6._1)
        addInParameter(Timezone6._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: YearToSecond?): Unit = setValue(Timezone6._1, value)
    ...
    fun set__1(field: Field<YearToSecond?>): Unit {
        setField(Timezone6._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: LocalDateTime?): Unit = setValue(Timezone6._2, value)
