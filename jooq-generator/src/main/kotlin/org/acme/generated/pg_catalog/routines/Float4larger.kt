...
open class Float4larger : AbstractRoutine<Float>("float4larger", PgCatalog.PG_CATALOG, SQLDataType.REAL) {
    ...
    init {
        returnParameter = Float4larger.RETURN_VALUE
        addInParameter(Float4larger._1)
        addInParameter(Float4larger._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Float?): Unit = setValue(Float4larger._1, value)
    ...
    fun set__1(field: Field<Float?>): Unit {
        setField(Float4larger._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Float?): Unit = setValue(Float4larger._2, value)
    ...
    fun set__2(field: Field<Float?>): Unit {
        setField(Float4larger._2, field)
    }
}
