...
open class Regexnesel : AbstractRoutine<Double>("regexnesel", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = Regexnesel.RETURN_VALUE
        addInParameter(Regexnesel._1)
        addInParameter(Regexnesel._2)
        addInParameter(Regexnesel._3)
        addInParameter(Regexnesel._4)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(Regexnesel._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(Regexnesel._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Regexnesel._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(Regexnesel._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(Regexnesel._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(Regexnesel._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Int?): Unit = setValue(Regexnesel._4, value)
