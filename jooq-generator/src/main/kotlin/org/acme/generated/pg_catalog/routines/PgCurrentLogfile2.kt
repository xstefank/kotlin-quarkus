...
open class PgCurrentLogfile2 : AbstractRoutine<String>("pg_current_logfile", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PgCurrentLogfile2.RETURN_VALUE
        addInParameter(PgCurrentLogfile2._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(PgCurrentLogfile2._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(PgCurrentLogfile2._1, field)
    }
}
