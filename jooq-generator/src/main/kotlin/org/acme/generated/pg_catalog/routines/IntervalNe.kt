...
open class IntervalNe : AbstractRoutine<Boolean>("interval_ne", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = IntervalNe.RETURN_VALUE
        addInParameter(IntervalNe._1)
        addInParameter(IntervalNe._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: YearToSecond?): Unit = setValue(IntervalNe._1, value)
    ...
    fun set__1(field: Field<YearToSecond?>): Unit {
        setField(IntervalNe._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: YearToSecond?): Unit = setValue(IntervalNe._2, value)
