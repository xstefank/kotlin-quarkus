...
open class Float8StddevPop : AbstractRoutine<Double>("float8_stddev_pop", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = Float8StddevPop.RETURN_VALUE
        addInParameter(Float8StddevPop._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Array<Double?>?): Unit = setValue(Float8StddevPop._1, value)
    ...
    fun set__1(field: Field<Array<Double?>?>): Unit {
        setField(Float8StddevPop._1, field)
    }
}
