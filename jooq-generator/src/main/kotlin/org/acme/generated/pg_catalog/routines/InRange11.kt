...
open class InRange11 : AbstractRoutine<Boolean>("in_range", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = InRange11.RETURN_VALUE
        addInParameter(InRange11._1)
        addInParameter(InRange11._2)
        addInParameter(InRange11._3)
        addInParameter(InRange11._4)
        addInParameter(InRange11._5)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: YearToSecond?): Unit = setValue(InRange11._1, value)
    ...
    fun set__1(field: Field<YearToSecond?>): Unit {
        setField(InRange11._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: YearToSecond?): Unit = setValue(InRange11._2, value)
    ...
    fun set__2(field: Field<YearToSecond?>): Unit {
        setField(InRange11._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: YearToSecond?): Unit = setValue(InRange11._3, value)
    ...
    fun set__3(field: Field<YearToSecond?>): Unit {
        setField(InRange11._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Boolean?): Unit = setValue(InRange11._4, value)
    ...
    fun set__4(field: Field<Boolean?>): Unit {
        setField(InRange11._4, field)
    }

    /**
     * Set the <code>_5</code> parameter IN value to the routine
     */
    fun set__5(value: Boolean?): Unit = setValue(InRange11._5, value)
