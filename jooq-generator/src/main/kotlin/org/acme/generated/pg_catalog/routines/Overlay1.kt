...
open class Overlay1 : AbstractRoutine<String>("overlay", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = Overlay1.RETURN_VALUE
        addInParameter(Overlay1._1)
        addInParameter(Overlay1._2)
        addInParameter(Overlay1._3)
        addInParameter(Overlay1._4)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Overlay1._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Overlay1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(Overlay1._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(Overlay1._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(Overlay1._3, value)
    ...
    fun set__3(field: Field<Int?>): Unit {
        setField(Overlay1._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Int?): Unit = setValue(Overlay1._4, value)
