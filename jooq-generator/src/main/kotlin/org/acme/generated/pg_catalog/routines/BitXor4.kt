...
open class BitXor4 : AbstractRoutine<String>("bit_xor", PgCatalog.PG_CATALOG, SQLDataType.CHAR) {
    companion object {
    ...
    init {
        returnParameter = BitXor4.RETURN_VALUE
        addInParameter(BitXor4._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(BitXor4._1, value)
