...
open class Substring7 : AbstractRoutine<String>("substring", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = Substring7.RETURN_VALUE
        addInParameter(Substring7._1)
        addInParameter(Substring7._2)
        addInParameter(Substring7._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Substring7._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Substring7._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Substring7._2, value)
    ...
    fun set__2(field: Field<Int?>): Unit {
        setField(Substring7._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(Substring7._3, value)
