...
open class TstzrangeSubdiff : AbstractRoutine<Double>("tstzrange_subdiff", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = TstzrangeSubdiff.RETURN_VALUE
        addInParameter(TstzrangeSubdiff._1)
        addInParameter(TstzrangeSubdiff._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: OffsetDateTime?): Unit = setValue(TstzrangeSubdiff._1, value)
    ...
    fun set__1(field: Field<OffsetDateTime?>): Unit {
        setField(TstzrangeSubdiff._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetDateTime?): Unit = setValue(TstzrangeSubdiff._2, value)
    ...
    fun set__2(field: Field<OffsetDateTime?>): Unit {
        setField(TstzrangeSubdiff._2, field)
    }
}
