...
open class Int4AvgAccum : AbstractRoutine<Array<Long?>>("int4_avg_accum", PgCatalog.PG_CATALOG, SQLDataType.BIGINT.array()) {
    companion object {
    ...
    init {
        returnParameter = Int4AvgAccum.RETURN_VALUE
        addInParameter(Int4AvgAccum._1)
        addInParameter(Int4AvgAccum._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Array<Long?>?): Unit = setValue(Int4AvgAccum._1, value)
    ...
    fun set__1(field: Field<Array<Long?>?>): Unit {
        setField(Int4AvgAccum._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Int4AvgAccum._2, value)
    ...
    fun set__2(field: Field<Int?>): Unit {
        setField(Int4AvgAccum._2, field)
    }
}
