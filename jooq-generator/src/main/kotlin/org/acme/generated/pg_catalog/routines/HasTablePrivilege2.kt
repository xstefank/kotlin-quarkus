...
open class HasTablePrivilege2 : AbstractRoutine<Boolean>("has_table_privilege", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = HasTablePrivilege2.RETURN_VALUE
        addInParameter(HasTablePrivilege2._1)
        addInParameter(HasTablePrivilege2._2)
        addInParameter(HasTablePrivilege2._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(HasTablePrivilege2._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(HasTablePrivilege2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(HasTablePrivilege2._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(HasTablePrivilege2._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: String?): Unit = setValue(HasTablePrivilege2._3, value)
    ...
    fun set__3(field: Field<String?>): Unit {
        setField(HasTablePrivilege2._3, field)
    }
}
