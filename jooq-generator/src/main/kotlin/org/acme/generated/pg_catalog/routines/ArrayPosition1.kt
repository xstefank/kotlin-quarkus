...
open class ArrayPosition1 : AbstractRoutine<Int>("array_position", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = ArrayPosition1.RETURN_VALUE
        addInParameter(ArrayPosition1._1)
        addInParameter(ArrayPosition1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Any?): Unit = setValue(ArrayPosition1._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(ArrayPosition1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(ArrayPosition1._2, value)
    ...
    fun set__2(field: Field<Any?>): Unit {
        setField(ArrayPosition1._2, field)
    }
}
