...
open class RecordGe : AbstractRoutine<Boolean>("record_ge", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = RecordGe.RETURN_VALUE
        addInParameter(RecordGe._1)
        addInParameter(RecordGe._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Record?): Unit = setValue(RecordGe._1, value)
    ...
    fun set__1(field: Field<Record?>): Unit {
        setField(RecordGe._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Record?): Unit = setValue(RecordGe._2, value)
