...
open class BitLength2 : AbstractRoutine<Int>("bit_length", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = BitLength2.RETURN_VALUE
        addInParameter(BitLength2._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(BitLength2._1, value)
