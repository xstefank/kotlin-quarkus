...
open class Timestamptz3 : AbstractRoutine<OffsetDateTime>("timestamptz", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6)) {
    ...
    init {
        returnParameter = Timestamptz3.RETURN_VALUE
        addInParameter(Timestamptz3._1)
        addInParameter(Timestamptz3._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: LocalDate?): Unit = setValue(Timestamptz3._1, value)
    ...
    fun set__1(field: Field<LocalDate?>): Unit {
        setField(Timestamptz3._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetTime?): Unit = setValue(Timestamptz3._2, value)
    ...
    fun set__2(field: Field<OffsetTime?>): Unit {
        setField(Timestamptz3._2, field)
    }
}
