...
open class PgGetExpr2 : AbstractRoutine<String>("pg_get_expr", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PgGetExpr2.RETURN_VALUE
        addInParameter(PgGetExpr2._1)
        addInParameter(PgGetExpr2._2)
        addInParameter(PgGetExpr2._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Any?): Unit = setValue(PgGetExpr2._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(PgGetExpr2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(PgGetExpr2._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(PgGetExpr2._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Boolean?): Unit = setValue(PgGetExpr2._3, value)
