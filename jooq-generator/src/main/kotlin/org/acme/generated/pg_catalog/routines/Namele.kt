...
open class Namele : AbstractRoutine<Boolean>("namele", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Namele.RETURN_VALUE
        addInParameter(Namele._1)
        addInParameter(Namele._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: String?): Unit = setValue(Namele._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Namele._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(Namele._2, value)
