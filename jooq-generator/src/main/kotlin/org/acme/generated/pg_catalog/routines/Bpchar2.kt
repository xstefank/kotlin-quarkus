...
open class Bpchar2 : AbstractRoutine<String>("bpchar", PgCatalog.PG_CATALOG, SQLDataType.CHAR) {
    ...
    init {
        returnParameter = Bpchar2.RETURN_VALUE
        addInParameter(Bpchar2._1)
        addInParameter(Bpchar2._2)
        addInParameter(Bpchar2._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Bpchar2._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Bpchar2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Bpchar2._2, value)
    ...
    fun set__2(field: Field<Int?>): Unit {
        setField(Bpchar2._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Boolean?): Unit = setValue(Bpchar2._3, value)
