...
open class BitXor2 : AbstractRoutine<Int>("bit_xor", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    companion object {
    ...
    init {
        returnParameter = BitXor2.RETURN_VALUE
        addInParameter(BitXor2._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Int?): Unit = setValue(BitXor2._1, value)
