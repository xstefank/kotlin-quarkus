...
open class Mod1 : AbstractRoutine<BigDecimal>("mod", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    ...
    init {
        returnParameter = Mod1.RETURN_VALUE
        addInParameter(Mod1._1)
        addInParameter(Mod1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: BigDecimal?): Unit = setValue(Mod1._1, value)
    ...
    fun set__1(field: Field<BigDecimal?>): Unit {
        setField(Mod1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: BigDecimal?): Unit = setValue(Mod1._2, value)
