...
open class Round2 : AbstractRoutine<BigDecimal>("round", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    ...
    init {
        returnParameter = Round2.RETURN_VALUE
        addInParameter(Round2._1)
        addInParameter(Round2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: BigDecimal?): Unit = setValue(Round2._1, value)
    ...
    fun set__1(field: Field<BigDecimal?>): Unit {
        setField(Round2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Round2._2, value)
