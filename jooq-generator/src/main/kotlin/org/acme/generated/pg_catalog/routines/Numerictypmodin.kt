...
open class Numerictypmodin : AbstractRoutine<Int>("numerictypmodin", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = Numerictypmodin.RETURN_VALUE
        addInParameter(Numerictypmodin._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Array<Any?>?): Unit = setValue(Numerictypmodin._1, value)
    ...
    fun set__1(field: Field<Array<Any?>?>): Unit {
        setField(Numerictypmodin._1, field)
    }
}
