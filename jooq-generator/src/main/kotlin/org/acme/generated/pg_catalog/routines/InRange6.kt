...
open class InRange6 : AbstractRoutine<Boolean>("in_range", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = InRange6.RETURN_VALUE
        addInParameter(InRange6._1)
        addInParameter(InRange6._2)
        addInParameter(InRange6._3)
        addInParameter(InRange6._4)
        addInParameter(InRange6._5)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Short?): Unit = setValue(InRange6._1, value)
    ...
    fun set__1(field: Field<Short?>): Unit {
        setField(InRange6._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Short?): Unit = setValue(InRange6._2, value)
    ...
    fun set__2(field: Field<Short?>): Unit {
        setField(InRange6._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(InRange6._3, value)
    ...
    fun set__3(field: Field<Int?>): Unit {
        setField(InRange6._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Boolean?): Unit = setValue(InRange6._4, value)
    ...
    fun set__4(field: Field<Boolean?>): Unit {
        setField(InRange6._4, field)
    }

    /**
     * Set the <code>_5</code> parameter IN value to the routine
     */
    fun set__5(value: Boolean?): Unit = setValue(InRange6._5, value)
