...
open class Notlike1 : AbstractRoutine<Boolean>("notlike", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Notlike1.RETURN_VALUE
        addInParameter(Notlike1._1)
        addInParameter(Notlike1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Notlike1._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Notlike1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(Notlike1._2, value)
