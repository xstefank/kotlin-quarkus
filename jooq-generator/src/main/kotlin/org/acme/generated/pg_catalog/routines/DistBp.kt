...
open class DistBp : AbstractRoutine<Double>("dist_bp", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = DistBp.RETURN_VALUE
        addInParameter(DistBp._1)
        addInParameter(DistBp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(DistBp._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(DistBp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(DistBp._2, value)
