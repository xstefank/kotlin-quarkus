...
open class BitXor3 : AbstractRoutine<Long>("bit_xor", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    companion object {
    ...
    init {
        returnParameter = BitXor3.RETURN_VALUE
        addInParameter(BitXor3._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Long?): Unit = setValue(BitXor3._1, value)
