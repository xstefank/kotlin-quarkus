...
open class Substr2 : AbstractRoutine<ByteArray>("substr", PgCatalog.PG_CATALOG, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = Substr2.RETURN_VALUE
        addInParameter(Substr2._1)
        addInParameter(Substr2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: ByteArray?): Unit = setValue(Substr2._1, value)
    ...
    fun set__1(field: Field<ByteArray?>): Unit {
        setField(Substr2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Substr2._2, value)
