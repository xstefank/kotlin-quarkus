...
open class WidthBucket2 : AbstractRoutine<Int>("width_bucket", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = WidthBucket2.RETURN_VALUE
        addInParameter(WidthBucket2._1)
        addInParameter(WidthBucket2._2)
        addInParameter(WidthBucket2._3)
        addInParameter(WidthBucket2._4)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Double?): Unit = setValue(WidthBucket2._1, value)
    ...
    fun set__1(field: Field<Double?>): Unit {
        setField(WidthBucket2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Double?): Unit = setValue(WidthBucket2._2, value)
    ...
    fun set__2(field: Field<Double?>): Unit {
        setField(WidthBucket2._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Double?): Unit = setValue(WidthBucket2._3, value)
    ...
    fun set__3(field: Field<Double?>): Unit {
        setField(WidthBucket2._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Int?): Unit = setValue(WidthBucket2._4, value)
    ...
    fun set__4(field: Field<Int?>): Unit {
        setField(WidthBucket2._4, field)
    }
}
