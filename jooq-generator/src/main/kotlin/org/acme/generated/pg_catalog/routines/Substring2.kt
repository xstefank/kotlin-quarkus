...
open class Substring2 : AbstractRoutine<String>("substring", PgCatalog.PG_CATALOG, SQLDataType.CHAR) {
    ...
    init {
        returnParameter = Substring2.RETURN_VALUE
        addInParameter(Substring2._1)
        addInParameter(Substring2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Substring2._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Substring2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Substring2._2, value)
