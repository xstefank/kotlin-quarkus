...
open class ArrayLower : AbstractRoutine<Int>("array_lower", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = ArrayLower.RETURN_VALUE
        addInParameter(ArrayLower._1)
        addInParameter(ArrayLower._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Array<Any?>?): Unit = setValue(ArrayLower._1, value)
    ...
    fun set__1(field: Field<Array<Any?>?>): Unit {
        setField(ArrayLower._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(ArrayLower._2, value)
