...
open class Varbittypmodin : AbstractRoutine<Int>("varbittypmodin", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = Varbittypmodin.RETURN_VALUE
        addInParameter(Varbittypmodin._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Array<Any?>?): Unit = setValue(Varbittypmodin._1, value)
    ...
    fun set__1(field: Field<Array<Any?>?>): Unit {
        setField(Varbittypmodin._1, field)
    }
}
