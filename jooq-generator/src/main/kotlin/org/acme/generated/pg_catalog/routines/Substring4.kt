...
open class Substring4 : AbstractRoutine<ByteArray>("substring", PgCatalog.PG_CATALOG, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = Substring4.RETURN_VALUE
        addInParameter(Substring4._1)
        addInParameter(Substring4._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: ByteArray?): Unit = setValue(Substring4._1, value)
    ...
    fun set__1(field: Field<ByteArray?>): Unit {
        setField(Substring4._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Substring4._2, value)
