...
open class LoGet2 : AbstractRoutine<ByteArray>("lo_get", PgCatalog.PG_CATALOG, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = LoGet2.RETURN_VALUE
        addInParameter(LoGet2._1)
        addInParameter(LoGet2._2)
        addInParameter(LoGet2._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Long?): Unit = setValue(LoGet2._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(LoGet2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(LoGet2._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(LoGet2._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(LoGet2._3, value)
