...
open class SetBit2 : AbstractRoutine<ByteArray>("set_bit", PgCatalog.PG_CATALOG, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = SetBit2.RETURN_VALUE
        addInParameter(SetBit2._1)
        addInParameter(SetBit2._2)
        addInParameter(SetBit2._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: ByteArray?): Unit = setValue(SetBit2._1, value)
    ...
    fun set__1(field: Field<ByteArray?>): Unit {
        setField(SetBit2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(SetBit2._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(SetBit2._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(SetBit2._3, value)
