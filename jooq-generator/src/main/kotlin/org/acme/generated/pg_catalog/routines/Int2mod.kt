...
open class Int2mod : AbstractRoutine<Short>("int2mod", PgCatalog.PG_CATALOG, SQLDataType.SMALLINT) {
    ...
    init {
        returnParameter = Int2mod.RETURN_VALUE
        addInParameter(Int2mod._1)
        addInParameter(Int2mod._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Short?): Unit = setValue(Int2mod._1, value)
    ...
    fun set__1(field: Field<Short?>): Unit {
        setField(Int2mod._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Short?): Unit = setValue(Int2mod._2, value)
