...
open class StddevSamp1 : AbstractRoutine<BigDecimal>("stddev_samp", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    ...
    init {
        returnParameter = StddevSamp1.RETURN_VALUE
        addInParameter(StddevSamp1._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Long?): Unit = setValue(StddevSamp1._1, value)
