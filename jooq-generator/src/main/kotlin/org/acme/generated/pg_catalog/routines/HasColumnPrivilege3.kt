...
open class HasColumnPrivilege3 : AbstractRoutine<Boolean>("has_column_privilege", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = HasColumnPrivilege3.RETURN_VALUE
        addInParameter(HasColumnPrivilege3._1)
        addInParameter(HasColumnPrivilege3._2)
        addInParameter(HasColumnPrivilege3._3)
        addInParameter(HasColumnPrivilege3._4)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(HasColumnPrivilege3._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(HasColumnPrivilege3._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(HasColumnPrivilege3._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(HasColumnPrivilege3._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: String?): Unit = setValue(HasColumnPrivilege3._3, value)
    ...
    fun set__3(field: Field<String?>): Unit {
        setField(HasColumnPrivilege3._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: String?): Unit = setValue(HasColumnPrivilege3._4, value)
    ...
    fun set__4(field: Field<String?>): Unit {
        setField(HasColumnPrivilege3._4, field)
    }
}
