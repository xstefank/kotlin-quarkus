...
open class Btrecordimagecmp : AbstractRoutine<Int>("btrecordimagecmp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = Btrecordimagecmp.RETURN_VALUE
        addInParameter(Btrecordimagecmp._1)
        addInParameter(Btrecordimagecmp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Record?): Unit = setValue(Btrecordimagecmp._1, value)
    ...
    fun set__1(field: Field<Record?>): Unit {
        setField(Btrecordimagecmp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Record?): Unit = setValue(Btrecordimagecmp._2, value)
    ...
    fun set__2(field: Field<Record?>): Unit {
        setField(Btrecordimagecmp._2, field)
    }
}
