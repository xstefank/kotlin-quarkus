...
open class Contsel : AbstractRoutine<Double>("contsel", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = Contsel.RETURN_VALUE
        addInParameter(Contsel._1)
        addInParameter(Contsel._2)
        addInParameter(Contsel._3)
        addInParameter(Contsel._4)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(Contsel._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(Contsel._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Contsel._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(Contsel._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(Contsel._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(Contsel._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Int?): Unit = setValue(Contsel._4, value)
