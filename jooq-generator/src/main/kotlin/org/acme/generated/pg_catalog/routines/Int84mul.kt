...
open class Int84mul : AbstractRoutine<Long>("int84mul", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    ...
    init {
        returnParameter = Int84mul.RETURN_VALUE
        addInParameter(Int84mul._1)
        addInParameter(Int84mul._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Long?): Unit = setValue(Int84mul._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(Int84mul._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Int84mul._2, value)
