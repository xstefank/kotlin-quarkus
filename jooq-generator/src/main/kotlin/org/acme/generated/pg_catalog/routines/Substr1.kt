...
open class Substr1 : AbstractRoutine<ByteArray>("substr", PgCatalog.PG_CATALOG, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = Substr1.RETURN_VALUE
        addInParameter(Substr1._1)
        addInParameter(Substr1._2)
        addInParameter(Substr1._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: ByteArray?): Unit = setValue(Substr1._1, value)
    ...
    fun set__1(field: Field<ByteArray?>): Unit {
        setField(Substr1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Substr1._2, value)
    ...
    fun set__2(field: Field<Int?>): Unit {
        setField(Substr1._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(Substr1._3, value)
