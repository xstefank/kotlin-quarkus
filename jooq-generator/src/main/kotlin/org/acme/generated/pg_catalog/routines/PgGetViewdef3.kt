...
open class PgGetViewdef3 : AbstractRoutine<String>("pg_get_viewdef", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PgGetViewdef3.RETURN_VALUE
        addInParameter(PgGetViewdef3._1)
        addInParameter(PgGetViewdef3._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(PgGetViewdef3._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(PgGetViewdef3._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Boolean?): Unit = setValue(PgGetViewdef3._2, value)
    ...
    fun set__2(field: Field<Boolean?>): Unit {
        setField(PgGetViewdef3._2, field)
    }
}
