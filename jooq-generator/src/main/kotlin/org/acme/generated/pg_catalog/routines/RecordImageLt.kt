...
open class RecordImageLt : AbstractRoutine<Boolean>("record_image_lt", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = RecordImageLt.RETURN_VALUE
        addInParameter(RecordImageLt._1)
        addInParameter(RecordImageLt._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Record?): Unit = setValue(RecordImageLt._1, value)
    ...
    fun set__1(field: Field<Record?>): Unit {
        setField(RecordImageLt._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Record?): Unit = setValue(RecordImageLt._2, value)
    ...
    fun set__2(field: Field<Record?>): Unit {
        setField(RecordImageLt._2, field)
    }
}
