...
open class Int4or : AbstractRoutine<Int>("int4or", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = Int4or.RETURN_VALUE
        addInParameter(Int4or._1)
        addInParameter(Int4or._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Int?): Unit = setValue(Int4or._1, value)
    ...
    fun set__1(field: Field<Int?>): Unit {
        setField(Int4or._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Int4or._2, value)
