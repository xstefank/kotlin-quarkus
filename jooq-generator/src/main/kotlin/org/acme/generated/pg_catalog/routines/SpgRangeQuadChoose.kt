...
open class SpgRangeQuadChoose : AbstractRoutine<java.lang.Void>("spg_range_quad_choose", PgCatalog.PG_CATALOG) {
    ...
    init {
        addInParameter(SpgRangeQuadChoose._1)
        addInParameter(SpgRangeQuadChoose._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(SpgRangeQuadChoose._1, value)

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(SpgRangeQuadChoose._2, value)
}
