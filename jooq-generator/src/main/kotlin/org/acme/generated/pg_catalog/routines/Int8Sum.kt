...
open class Int8Sum : AbstractRoutine<BigDecimal>("int8_sum", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    ...
    init {
        returnParameter = Int8Sum.RETURN_VALUE
        addInParameter(Int8Sum._1)
        addInParameter(Int8Sum._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: BigDecimal?): Unit = setValue(Int8Sum._1, value)
    ...
    fun set__1(field: Field<BigDecimal?>): Unit {
        setField(Int8Sum._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Int8Sum._2, value)
