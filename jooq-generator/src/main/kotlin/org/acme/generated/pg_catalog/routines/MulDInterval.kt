...
open class MulDInterval : AbstractRoutine<YearToSecond>("mul_d_interval", PgCatalog.PG_CATALOG, SQLDataType.INTERVAL) {
    ...
    init {
        returnParameter = MulDInterval.RETURN_VALUE
        addInParameter(MulDInterval._1)
        addInParameter(MulDInterval._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Double?): Unit = setValue(MulDInterval._1, value)
    ...
    fun set__1(field: Field<Double?>): Unit {
        setField(MulDInterval._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: YearToSecond?): Unit = setValue(MulDInterval._2, value)
    ...
    fun set__2(field: Field<YearToSecond?>): Unit {
        setField(MulDInterval._2, field)
    }
}
