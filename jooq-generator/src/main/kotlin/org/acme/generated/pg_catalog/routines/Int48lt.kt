...
open class Int48lt : AbstractRoutine<Boolean>("int48lt", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Int48lt.RETURN_VALUE
        addInParameter(Int48lt._1)
        addInParameter(Int48lt._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Int?): Unit = setValue(Int48lt._1, value)
    ...
    fun set__1(field: Field<Int?>): Unit {
        setField(Int48lt._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Int48lt._2, value)
