...
open class CharacterLength2 : AbstractRoutine<Int>("character_length", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = CharacterLength2.RETURN_VALUE
        addInParameter(CharacterLength2._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(CharacterLength2._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(CharacterLength2._1, field)
    }
}
