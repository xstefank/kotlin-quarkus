...
open class DateGeTimestamp : AbstractRoutine<Boolean>("date_ge_timestamp", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = DateGeTimestamp.RETURN_VALUE
        addInParameter(DateGeTimestamp._1)
        addInParameter(DateGeTimestamp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: LocalDate?): Unit = setValue(DateGeTimestamp._1, value)
    ...
    fun set__1(field: Field<LocalDate?>): Unit {
        setField(DateGeTimestamp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: LocalDateTime?): Unit = setValue(DateGeTimestamp._2, value)
    ...
    fun set__2(field: Field<LocalDateTime?>): Unit {
        setField(DateGeTimestamp._2, field)
    }
}
