...
open class Log2 : AbstractRoutine<BigDecimal>("log", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    ...
    init {
        returnParameter = Log2.RETURN_VALUE
        addInParameter(Log2._1)
        addInParameter(Log2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: BigDecimal?): Unit = setValue(Log2._1, value)
    ...
    fun set__1(field: Field<BigDecimal?>): Unit {
        setField(Log2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: BigDecimal?): Unit = setValue(Log2._2, value)
