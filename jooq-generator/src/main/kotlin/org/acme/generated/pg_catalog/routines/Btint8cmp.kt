...
open class Btint8cmp : AbstractRoutine<Int>("btint8cmp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = Btint8cmp.RETURN_VALUE
        addInParameter(Btint8cmp._1)
        addInParameter(Btint8cmp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Long?): Unit = setValue(Btint8cmp._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(Btint8cmp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Btint8cmp._2, value)
