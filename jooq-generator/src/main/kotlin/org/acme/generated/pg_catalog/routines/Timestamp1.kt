...
open class Timestamp1 : AbstractRoutine<LocalDateTime>("timestamp", PgCatalog.PG_CATALOG, SQLDataType.LOCALDATETIME(6)) {
    ...
    init {
        returnParameter = Timestamp1.RETURN_VALUE
        addInParameter(Timestamp1._1)
        addInParameter(Timestamp1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: LocalDateTime?): Unit = setValue(Timestamp1._1, value)
    ...
    fun set__1(field: Field<LocalDateTime?>): Unit {
        setField(Timestamp1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Timestamp1._2, value)
