...
open class JsonbPathExistsTz : AbstractRoutine<Boolean>("jsonb_path_exists_tz", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = JsonbPathExistsTz.RETURN_VALUE
        addInParameter(JsonbPathExistsTz.TARGET)
        addInParameter(JsonbPathExistsTz.PATH)
        addInParameter(JsonbPathExistsTz.VARS)
        addInParameter(JsonbPathExistsTz.SILENT)
    }

    /**
     * Set the <code>target</code> parameter IN value to the routine
     */
    fun setTarget(value: JSONB?): Unit = setValue(JsonbPathExistsTz.TARGET, value)
    ...
    fun setTarget(field: Field<JSONB?>): Unit {
        setField(JsonbPathExistsTz.TARGET, field)
    }

    /**
     * Set the <code>path</code> parameter IN value to the routine
     */
    fun setPath(value: Any?): Unit = setValue(JsonbPathExistsTz.PATH, value)
    ...
    fun setPath(field: Field<Any?>): Unit {
        setField(JsonbPathExistsTz.PATH, field)
    }

    /**
     * Set the <code>vars</code> parameter IN value to the routine
     */
    fun setVars(value: JSONB?): Unit = setValue(JsonbPathExistsTz.VARS, value)
    ...
    fun setVars(field: Field<JSONB?>): Unit {
        setField(JsonbPathExistsTz.VARS, field)
    }

    /**
     * Set the <code>silent</code> parameter IN value to the routine
     */
    fun setSilent(value: Boolean?): Unit = setValue(JsonbPathExistsTz.SILENT, value)
    ...
    fun setSilent(field: Field<Boolean?>): Unit {
        setField(JsonbPathExistsTz.SILENT, field)
    }
}
