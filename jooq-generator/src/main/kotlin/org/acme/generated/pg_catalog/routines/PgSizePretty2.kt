...
open class PgSizePretty2 : AbstractRoutine<String>("pg_size_pretty", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PgSizePretty2.RETURN_VALUE
        addInParameter(PgSizePretty2._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: BigDecimal?): Unit = setValue(PgSizePretty2._1, value)
    ...
    fun set__1(field: Field<BigDecimal?>): Unit {
        setField(PgSizePretty2._1, field)
    }
}
