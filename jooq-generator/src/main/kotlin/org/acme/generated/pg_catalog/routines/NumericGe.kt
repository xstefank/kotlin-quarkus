...
open class NumericGe : AbstractRoutine<Boolean>("numeric_ge", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = NumericGe.RETURN_VALUE
        addInParameter(NumericGe._1)
        addInParameter(NumericGe._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: BigDecimal?): Unit = setValue(NumericGe._1, value)
    ...
    fun set__1(field: Field<BigDecimal?>): Unit {
        setField(NumericGe._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: BigDecimal?): Unit = setValue(NumericGe._2, value)
