...
open class JsonToTsvector1 : AbstractRoutine<Any>("json_to_tsvector", PgCatalog.PG_CATALOG, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"tsvector\"")) {
    companion object {
        @Deprecated(message = "Unknown data type. If this is a qualified, user-defined type, it may have been excluded from code generation. If this is a built-in type, you can define an explicit org.jooq.Binding to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.")
    ...
    init {
        returnParameter = JsonToTsvector1.RETURN_VALUE
        addInParameter(JsonToTsvector1._1)
        addInParameter(JsonToTsvector1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: JSON?): Unit = setValue(JsonToTsvector1._1, value)
    ...
    fun set__1(field: Field<JSON?>): Unit {
        setField(JsonToTsvector1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: JSONB?): Unit = setValue(JsonToTsvector1._2, value)
    ...
    fun set__2(field: Field<JSONB?>): Unit {
        setField(JsonToTsvector1._2, field)
    }
}
