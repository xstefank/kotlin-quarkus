...
open class Substr4 : AbstractRoutine<String>("substr", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = Substr4.RETURN_VALUE
        addInParameter(Substr4._1)
        addInParameter(Substr4._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Substr4._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Substr4._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Substr4._2, value)
