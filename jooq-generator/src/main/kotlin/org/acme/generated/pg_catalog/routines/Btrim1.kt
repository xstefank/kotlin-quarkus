...
open class Btrim1 : AbstractRoutine<ByteArray>("btrim", PgCatalog.PG_CATALOG, SQLDataType.BLOB) {
    ...
    init {
        returnParameter = Btrim1.RETURN_VALUE
        addInParameter(Btrim1._1)
        addInParameter(Btrim1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: ByteArray?): Unit = setValue(Btrim1._1, value)
    ...
    fun set__1(field: Field<ByteArray?>): Unit {
        setField(Btrim1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: ByteArray?): Unit = setValue(Btrim1._2, value)
