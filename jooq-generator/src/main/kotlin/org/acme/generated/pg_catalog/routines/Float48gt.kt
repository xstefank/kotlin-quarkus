...
open class Float48gt : AbstractRoutine<Boolean>("float48gt", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Float48gt.RETURN_VALUE
        addInParameter(Float48gt._1)
        addInParameter(Float48gt._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Float?): Unit = setValue(Float48gt._1, value)
    ...
    fun set__1(field: Field<Float?>): Unit {
        setField(Float48gt._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Double?): Unit = setValue(Float48gt._2, value)
