...
open class DateTrunc4 : AbstractRoutine<LocalDateTime>("date_trunc", PgCatalog.PG_CATALOG, SQLDataType.LOCALDATETIME(6)) {
    ...
    init {
        returnParameter = DateTrunc4.RETURN_VALUE
        addInParameter(DateTrunc4._1)
        addInParameter(DateTrunc4._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(DateTrunc4._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(DateTrunc4._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: LocalDateTime?): Unit = setValue(DateTrunc4._2, value)
