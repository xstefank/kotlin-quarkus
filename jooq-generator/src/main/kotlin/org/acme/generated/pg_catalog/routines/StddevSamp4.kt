...
open class StddevSamp4 : AbstractRoutine<Double>("stddev_samp", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = StddevSamp4.RETURN_VALUE
        addInParameter(StddevSamp4._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Float?): Unit = setValue(StddevSamp4._1, value)
