...
open class DateBin1 : AbstractRoutine<LocalDateTime>("date_bin", PgCatalog.PG_CATALOG, SQLDataType.LOCALDATETIME(6)) {
    companion object {
    ...
    init {
        returnParameter = DateBin1.RETURN_VALUE
        addInParameter(DateBin1._1)
        addInParameter(DateBin1._2)
        addInParameter(DateBin1._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: YearToSecond?): Unit = setValue(DateBin1._1, value)
    ...
    fun set__1(field: Field<YearToSecond?>): Unit {
        setField(DateBin1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: LocalDateTime?): Unit = setValue(DateBin1._2, value)
    ...
    fun set__2(field: Field<LocalDateTime?>): Unit {
        setField(DateBin1._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: LocalDateTime?): Unit = setValue(DateBin1._3, value)
