...
open class TimestampLarger : AbstractRoutine<LocalDateTime>("timestamp_larger", PgCatalog.PG_CATALOG, SQLDataType.LOCALDATETIME(6)) {
    ...
    init {
        returnParameter = TimestampLarger.RETURN_VALUE
        addInParameter(TimestampLarger._1)
        addInParameter(TimestampLarger._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: LocalDateTime?): Unit = setValue(TimestampLarger._1, value)
    ...
    fun set__1(field: Field<LocalDateTime?>): Unit {
        setField(TimestampLarger._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: LocalDateTime?): Unit = setValue(TimestampLarger._2, value)
    ...
    fun set__2(field: Field<LocalDateTime?>): Unit {
        setField(TimestampLarger._2, field)
    }
}
