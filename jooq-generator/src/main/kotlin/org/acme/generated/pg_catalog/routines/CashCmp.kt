...
open class CashCmp : AbstractRoutine<Int>("cash_cmp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = CashCmp.RETURN_VALUE
        addInParameter(CashCmp._1)
        addInParameter(CashCmp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(CashCmp._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(CashCmp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(CashCmp._2, value)
