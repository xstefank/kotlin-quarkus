...
open class ToChar3 : AbstractRoutine<String>("to_char", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = ToChar3.RETURN_VALUE
        addInParameter(ToChar3._1)
        addInParameter(ToChar3._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: BigDecimal?): Unit = setValue(ToChar3._1, value)
    ...
    fun set__1(field: Field<BigDecimal?>): Unit {
        setField(ToChar3._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(ToChar3._2, value)
