...
open class Likesel : AbstractRoutine<Double>("likesel", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = Likesel.RETURN_VALUE
        addInParameter(Likesel._1)
        addInParameter(Likesel._2)
        addInParameter(Likesel._3)
        addInParameter(Likesel._4)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(Likesel._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(Likesel._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Likesel._2, value)
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(Likesel._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Any?): Unit = setValue(Likesel._3, value)
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(Likesel._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Int?): Unit = setValue(Likesel._4, value)
