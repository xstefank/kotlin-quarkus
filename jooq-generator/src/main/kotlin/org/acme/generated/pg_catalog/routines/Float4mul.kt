...
open class Float4mul : AbstractRoutine<Float>("float4mul", PgCatalog.PG_CATALOG, SQLDataType.REAL) {
    ...
    init {
        returnParameter = Float4mul.RETURN_VALUE
        addInParameter(Float4mul._1)
        addInParameter(Float4mul._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Float?): Unit = setValue(Float4mul._1, value)
    ...
    fun set__1(field: Field<Float?>): Unit {
        setField(Float4mul._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Float?): Unit = setValue(Float4mul._2, value)
