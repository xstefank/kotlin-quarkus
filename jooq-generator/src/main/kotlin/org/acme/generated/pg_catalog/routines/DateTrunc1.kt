...
open class DateTrunc1 : AbstractRoutine<OffsetDateTime>("date_trunc", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6)) {
    ...
    init {
        returnParameter = DateTrunc1.RETURN_VALUE
        addInParameter(DateTrunc1._1)
        addInParameter(DateTrunc1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(DateTrunc1._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(DateTrunc1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetDateTime?): Unit = setValue(DateTrunc1._2, value)
