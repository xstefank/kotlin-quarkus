...
open class TsHeadline4 : AbstractRoutine<String>("ts_headline", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = TsHeadline4.RETURN_VALUE
        addInParameter(TsHeadline4._1)
        addInParameter(TsHeadline4._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(TsHeadline4._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(TsHeadline4._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Any?): Unit = setValue(TsHeadline4._2, value)
