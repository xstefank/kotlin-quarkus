...
open class Trunc2 : AbstractRoutine<BigDecimal>("trunc", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC) {
    ...
    init {
        returnParameter = Trunc2.RETURN_VALUE
        addInParameter(Trunc2._1)
        addInParameter(Trunc2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: BigDecimal?): Unit = setValue(Trunc2._1, value)
    ...
    fun set__1(field: Field<BigDecimal?>): Unit {
        setField(Trunc2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Trunc2._2, value)
