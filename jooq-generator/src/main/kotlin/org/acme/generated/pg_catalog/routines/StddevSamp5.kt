...
open class StddevSamp5 : AbstractRoutine<Double>("stddev_samp", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = StddevSamp5.RETURN_VALUE
        addInParameter(StddevSamp5._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Double?): Unit = setValue(StddevSamp5._1, value)
