...
open class TimestamptzEq : AbstractRoutine<Boolean>("timestamptz_eq", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = TimestamptzEq.RETURN_VALUE
        addInParameter(TimestamptzEq._1)
        addInParameter(TimestamptzEq._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: OffsetDateTime?): Unit = setValue(TimestamptzEq._1, value)
    ...
    fun set__1(field: Field<OffsetDateTime?>): Unit {
        setField(TimestamptzEq._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetDateTime?): Unit = setValue(TimestamptzEq._2, value)
    ...
    fun set__2(field: Field<OffsetDateTime?>): Unit {
        setField(TimestamptzEq._2, field)
    }
}
