...
open class Timezone2 : AbstractRoutine<LocalDateTime>("timezone", PgCatalog.PG_CATALOG, SQLDataType.LOCALDATETIME(6)) {
    ...
    init {
        returnParameter = Timezone2.RETURN_VALUE
        addInParameter(Timezone2._1)
        addInParameter(Timezone2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Timezone2._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Timezone2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetDateTime?): Unit = setValue(Timezone2._2, value)
