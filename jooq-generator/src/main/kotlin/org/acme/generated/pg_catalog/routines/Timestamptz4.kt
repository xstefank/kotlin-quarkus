...
open class Timestamptz4 : AbstractRoutine<OffsetDateTime>("timestamptz", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6)) {
    ...
    init {
        returnParameter = Timestamptz4.RETURN_VALUE
        addInParameter(Timestamptz4._1)
        addInParameter(Timestamptz4._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: OffsetDateTime?): Unit = setValue(Timestamptz4._1, value)
    ...
    fun set__1(field: Field<OffsetDateTime?>): Unit {
        setField(Timestamptz4._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Timestamptz4._2, value)
    ...
    fun set__2(field: Field<Int?>): Unit {
        setField(Timestamptz4._2, field)
    }
}
