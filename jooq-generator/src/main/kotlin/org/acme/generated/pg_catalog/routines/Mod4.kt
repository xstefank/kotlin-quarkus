...
open class Mod4 : AbstractRoutine<Long>("mod", PgCatalog.PG_CATALOG, SQLDataType.BIGINT) {
    ...
    init {
        returnParameter = Mod4.RETURN_VALUE
        addInParameter(Mod4._1)
        addInParameter(Mod4._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Long?): Unit = setValue(Mod4._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(Mod4._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Mod4._2, value)
