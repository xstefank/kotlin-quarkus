...
open class Int48ne : AbstractRoutine<Boolean>("int48ne", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = Int48ne.RETURN_VALUE
        addInParameter(Int48ne._1)
        addInParameter(Int48ne._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Int?): Unit = setValue(Int48ne._1, value)
    ...
    fun set__1(field: Field<Int?>): Unit {
        setField(Int48ne._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Long?): Unit = setValue(Int48ne._2, value)
