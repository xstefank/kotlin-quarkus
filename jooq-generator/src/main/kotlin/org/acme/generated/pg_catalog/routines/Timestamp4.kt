...
open class Timestamp4 : AbstractRoutine<LocalDateTime>("timestamp", PgCatalog.PG_CATALOG, SQLDataType.LOCALDATETIME(6)) {
    ...
    init {
        returnParameter = Timestamp4.RETURN_VALUE
        addInParameter(Timestamp4._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: OffsetDateTime?): Unit = setValue(Timestamp4._1, value)
