...
open class InRange5 : AbstractRoutine<Boolean>("in_range", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = InRange5.RETURN_VALUE
        addInParameter(InRange5._1)
        addInParameter(InRange5._2)
        addInParameter(InRange5._3)
        addInParameter(InRange5._4)
        addInParameter(InRange5._5)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Short?): Unit = setValue(InRange5._1, value)
    ...
    fun set__1(field: Field<Short?>): Unit {
        setField(InRange5._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Short?): Unit = setValue(InRange5._2, value)
    ...
    fun set__2(field: Field<Short?>): Unit {
        setField(InRange5._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Long?): Unit = setValue(InRange5._3, value)
    ...
    fun set__3(field: Field<Long?>): Unit {
        setField(InRange5._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Boolean?): Unit = setValue(InRange5._4, value)
    ...
    fun set__4(field: Field<Boolean?>): Unit {
        setField(InRange5._4, field)
    }

    /**
     * Set the <code>_5</code> parameter IN value to the routine
     */
    fun set__5(value: Boolean?): Unit = setValue(InRange5._5, value)
