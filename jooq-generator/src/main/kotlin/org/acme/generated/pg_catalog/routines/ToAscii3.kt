...
open class ToAscii3 : AbstractRoutine<String>("to_ascii", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = ToAscii3.RETURN_VALUE
        addInParameter(ToAscii3._1)
        addInParameter(ToAscii3._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(ToAscii3._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(ToAscii3._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(ToAscii3._2, value)
