...
open class ObjDescription1 : AbstractRoutine<String>("obj_description", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = ObjDescription1.RETURN_VALUE
        addInParameter(ObjDescription1._1)
        addInParameter(ObjDescription1._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Long?): Unit = setValue(ObjDescription1._1, value)
    ...
    fun set__1(field: Field<Long?>): Unit {
        setField(ObjDescription1._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: String?): Unit = setValue(ObjDescription1._2, value)
    ...
    fun set__2(field: Field<String?>): Unit {
        setField(ObjDescription1._2, field)
    }
}
