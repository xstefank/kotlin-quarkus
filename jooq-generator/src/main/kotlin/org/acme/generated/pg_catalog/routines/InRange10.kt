...
open class InRange10 : AbstractRoutine<Boolean>("in_range", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN) {
    ...
    init {
        returnParameter = InRange10.RETURN_VALUE
        addInParameter(InRange10._1)
        addInParameter(InRange10._2)
        addInParameter(InRange10._3)
        addInParameter(InRange10._4)
        addInParameter(InRange10._5)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: OffsetDateTime?): Unit = setValue(InRange10._1, value)
    ...
    fun set__1(field: Field<OffsetDateTime?>): Unit {
        setField(InRange10._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: OffsetDateTime?): Unit = setValue(InRange10._2, value)
    ...
    fun set__2(field: Field<OffsetDateTime?>): Unit {
        setField(InRange10._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: YearToSecond?): Unit = setValue(InRange10._3, value)
    ...
    fun set__3(field: Field<YearToSecond?>): Unit {
        setField(InRange10._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Boolean?): Unit = setValue(InRange10._4, value)
    ...
    fun set__4(field: Field<Boolean?>): Unit {
        setField(InRange10._4, field)
    }

    /**
     * Set the <code>_5</code> parameter IN value to the routine
     */
    fun set__5(value: Boolean?): Unit = setValue(InRange10._5, value)
