...
open class Substr3 : AbstractRoutine<String>("substr", PgCatalog.PG_CATALOG, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = Substr3.RETURN_VALUE
        addInParameter(Substr3._1)
        addInParameter(Substr3._2)
        addInParameter(Substr3._3)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(Substr3._1, value)
    ...
    fun set__1(field: Field<String?>): Unit {
        setField(Substr3._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Substr3._2, value)
    ...
    fun set__2(field: Field<Int?>): Unit {
        setField(Substr3._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(Substr3._3, value)
