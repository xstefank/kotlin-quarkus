...
open class PercentRank2 : AbstractRoutine<Double>("percent_rank", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE) {
    ...
    init {
        returnParameter = PercentRank2.RETURN_VALUE
        addInParameter(PercentRank2._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Any?): Unit = setValue(PercentRank2._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(PercentRank2._1, field)
    }
}
